...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function co(){return new wt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ta(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function uo(){return new wt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ta(),fragmentShader:`
	...
	`}function Xd(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Is||l===Ns,u=l===gi||l===vi;if(c||u){let f=e.get(a);const p=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==p)return t===null&&(t=new oo(i)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),f.texture;if(f!==void 0)return f.texture;{const m=a.image;return c&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new oo(i)),f=c?t.fromEquirectangular(a):t.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),a.addEventListener("dispose",s),f.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Yd(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&br("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function qd(i,e,t,n){const r={},s=new WeakMap;function o(f){const p=f.target;p.index!==null&&e.remove(p.index);for(const _ in p.attributes)e.remove(p.attributes[_]);for(const _ in p.morphAttributes){const x=p.morphAttributes[_];for(let h=0,d=x.length;h<d;h++)e.remove(x[h])}p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(e.remove(m),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(f,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,t.memory.geometries++),p}function l(f){const p=f.attributes;for(const _ in p)e.update(p[_],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const _ in m){const x=m[_];for(let h=0,d=x.length;h<d;h++)e.update(x[h],i.ARRAY_BUFFER)}}function c(f){const p=[],m=f.index,_=f.attributes.position;let x=0;if(m!==null){const A=m.array;x=m.version;for(let E=0,T=A.length;E<T;E+=3){const B=A[E+0],L=A[E+1],b=A[E+2];p.push(B,L,L,b,b,B)}}else if(_!==void 0){const A=_.array;x=_.version;for(let E=0,T=A.length/3-1;E<T;E+=3){const B=E+0,L=E+1,b=E+2;p.push(B,L,L,b,b,B)}}else return;const h=new(dl(p)?Sl:xl)(p,1);h.version=x;const d=s.get(f);d&&e.remove(d),s.set(f,h)}function u(f){const p=s.get(f);if(p){const m=f.index;m!==null&&p.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function Zd(i,e,t){let n;function r(p){n=p}let s,o;function a(p){s=p.type,o=p.bytesPerElement}function l(p,m){i.drawElements(n,m,s,p*o),t.update(m,n,1)}function c(p,m,_){_!==0&&(i.drawElementsInstanced(n,m,s,p*o,_),t.update(m,n,_))}function u(p,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,p,0,_);let h=0;for(let d=0;d<_;d++)h+=m[d];t.update(h,n,1)}function f(p,m,_,x){if(_===0)return;const h=e.get("WEBGL_multi_draw");if(h===null)for(let d=0;d<p.length;d++)c(p[d]/o,m[d],x[d]);else{h.multiDrawElementsInstancedWEBGL(n,m,0,s,p,0,x,0,_);let d=0;for(let A=0;A<_;A++)d+=m[A];for(let A=0;A<x.length;A++)t.update(d,n,x[A])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function Kd(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function jd(i,e,t){const n=new WeakMap,r=new st;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let p=n.get(a);if(p===void 0||p.count!==f){let g=function(){O.dispose(),n.delete(a),a.removeEventListener("dispose",g)};var m=g;p!==void 0&&p.texture.dispose();const _=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,h=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],A=a.morphAttributes.normal||[],E=a.morphAttributes.color||[];let T=0;_===!0&&(T=1),x===!0&&(T=2),h===!0&&(T=3);let B=a.attributes.position.count*T,L=1;B>e.maxTextureSize&&(L=Math.ceil(B/e.maxTextureSize),B=e.maxTextureSize);const b=new Float32Array(B*L*4*f),O=new pl(b,B,L,f);O.type=jt,O.needsUpdate=!0;const ie=T*4;for(let M=0;M<f;M++){const k=d[M],z=A[M],Z=E[M],Q=B*L*4*M;for(let V=0;V<k.count;V++){const J=V*ie;_===!0&&(r.fromBufferAttribute(k,V),b[Q+J+0]=r.x,b[Q+J+1]=r.y,b[Q+J+2]=r.z,b[Q+J+3]=0),x===!0&&(r.fromBufferAttribute(z,V),b[Q+J+4]=r.x,b[Q+J+5]=r.y,b[Q+J+6]=r.z,b[Q+J+7]=0),h===!0&&(r.fromBufferAttribute(Z,V),b[Q+J+8]=r.x,b[Q+J+9]=r.y,b[Q+J+10]=r.z,b[Q+J+11]=Z.itemSize===4?r.w:1)}}p={count:f,texture:O,size:new Pe(B,L)},n.set(a,p),a.addEventListener("dispose",g)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let _=0;for(let h=0;h<c.length;h++)_+=c[h];const x=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}return{update:s}}function $d(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,f=e.get(l,u);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class Tl extends Et{constructor(e,t,n,r,s,o,a,l,c,u=pi){if(u!==pi&&u!==Si)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===pi&&(n=Wn),n===void 0&&u===Si&&(n=xi),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:bt,this.minFilter=l!==void 0?l:bt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Al=new Et,ho=new Tl(1,1),bl=new pl,wl=new Bc,Rl=new El,fo=[],po=[],mo=new Float32Array(16),_o=new Float32Array(9),go=new Float32Array(4);function yi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=fo[r];if(s===void 0&&(s=new Float32Array(r),fo[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function pt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function mt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function zr(i,e){let t=po[e];t===void 0&&(t=new Int32Array(e),po[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Jd(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Qd(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2fv(this.addr,e),mt(t,e)}}function ef(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(pt(t,e))return;i.uniform3fv(this.addr,e),mt(t,e)}}function tf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4fv(this.addr,e),mt(t,e)}}function nf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;go.set(n),i.uniformMatrix2fv(this.addr,!1,go),mt(t,n)}}function rf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;_o.set(n),i.uniformMatrix3fv(this.addr,!1,_o),mt(t,n)}}function sf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;mo.set(n),i.uniformMatrix4fv(this.addr,!1,mo),mt(t,n)}}function af(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function of(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2iv(this.addr,e),mt(t,e)}}function lf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pt(t,e))return;i.uniform3iv(this.addr,e),mt(t,e)}}function cf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4iv(this.addr,e),mt(t,e)}}function uf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function hf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2uiv(this.addr,e),mt(t,e)}}function df(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pt(t,e))return;i.uniform3uiv(this.addr,e),mt(t,e)}}function ff(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4uiv(this.addr,e),mt(t,e)}}function pf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(ho.compareFunction=hl,s=ho):s=Al,t.setTexture2D(e||s,r)}function mf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||wl,r)}function _f(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Rl,r)}function gf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||bl,r)}function vf(i){switch(i){case 5126:return Jd;case 35664:return Qd;case 35665:return ef;case 35666:return tf;case 35674:return nf;case 35675:return rf;case 35676:return sf;case 5124:case 35670:return af;case 35667:case 35671:return of;case 35668:case 35672:return lf;case 35669:case 35673:return cf;case 5125:return uf;case 36294:return hf;case 36295:return df;case 36296:return ff;case 35678:case 36198:case 36298:case 36306:case 35682:return pf;case 35679:case 36299:case 36307:return mf;case 35680:case 36300:case 36308:case 36293:return _f;case 36289:case 36303:case 36311:case 36292:return gf}}function xf(i,e){i.uniform1fv(this.addr,e)}function Sf(i,e){const t=yi(e,this.size,2);i.uniform2fv(this.addr,t)}function Mf(i,e){const t=yi(e,this.size,3);i.uniform3fv(this.addr,t)}function Ef(i,e){const t=yi(e,this.size,4);i.uniform4fv(this.addr,t)}function yf(i,e){const t=yi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Tf(i,e){const t=yi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Af(i,e){const t=yi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function bf(i,e){i.uniform1iv(this.addr,e)}function wf(i,e){i.uniform2iv(this.addr,e)}function Rf(i,e){i.uniform3iv(this.addr,e)}function Cf(i,e){i.uniform4iv(this.addr,e)}function Pf(i,e){i.uniform1uiv(this.addr,e)}function Lf(i,e){i.uniform2uiv(this.addr,e)}function Df(i,e){i.uniform3uiv(this.addr,e)}function Uf(i,e){i.uniform4uiv(this.addr,e)}function If(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Al,s[o])}function Nf(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||wl,s[o])}function Ff(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Rl,s[o])}function Of(i,e,t){const n=this.cache,r=e.length,s=zr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||bl,s[o])}function Bf(i){switch(i){case 5126:return xf;case 35664:return Sf;case 35665:return Mf;case 35666:return Ef;case 35674:return yf;case 35675:return Tf;case 35676:return Af;case 5124:case 35670:return bf;case 35667:case 35671:return wf;case 35668:case 35672:return Rf;case 35669:case 35673:return Cf;case 5125:return Pf;case 36294:return Lf;case 36295:return Df;case 36296:return Uf;case 35678:case 36198:case 36298:case 36306:case 35682:return If;case 35679:case 36299:case 36307:return Nf;case 35680:case 36300:case 36308:case 36293:return Ff;case 36289:case 36303:case 36311:case 36292:return Of}}class zf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=vf(t.type)}}class Hf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Bf(t.type)}}class Gf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const xs=/(\w+)(\])?(\[|\.)?/g;function vo(i,e){i.seq.push(e),i.map[e.id]=e}function kf(i,e,t){const n=i.name,r=n.length;for(xs.lastIndex=0;;){const s=xs.exec(n),o=xs.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){vo(t,c===void 0?new zf(a,i,e):new Hf(a,i,e));break}else{let f=t.map[a];f===void 0&&(f=new Gf(a),vo(t,f)),t=f}}}class wr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);kf(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function xo(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Vf=37297;let Wf=0;function Xf(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}function Yf(i){const e=$e.getPrimaries($e.workingColorSpace),t=$e.getPrimaries(i);let n;switch(e===t?n="":e===Lr&&t===Pr?n="LinearDisplayP3ToLinearSRGB":e===Pr&&t===Lr&&(n="LinearSRGBToLinearDisplayP3"),i){case Cn:case Or:return[n,"LinearTransferOETF"];case en:case Sa:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",i),[n,"LinearTransferOETF"]}}function So(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Xf(i.getShaderSource(e),o)}else return r}function qf(i,e){const t=Yf(e);return`vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Zf(i,e){let t;switch(e){case lc:t="Linear";break;case cc:t="Reinhard";break;case uc:t="Cineon";break;case hc:t="ACESFilmic";break;case fc:t="AgX";break;case pc:t="Neutral";break;case dc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ur=new U;function Kf(){$e.getLuminanceCoefficients(ur);const i=ur.x.toFixed(4),e=ur.y.toFixed(4),t=ur.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function rp(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===da?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Gl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===hn&&(e="SHADOWMAP_TYPE_VSM"),e}function sp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case gi:case vi:e="ENVMAP_TYPE_CUBE";break;case Fr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ap(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case vi:e="ENVMAP_MODE_REFRACTION";break}return e}function op(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Qo:e="ENVMAP_BLENDING_MULTIPLY";break;case ac:e="ENVMAP_BLENDING_MIX";break;case oc:e="ENVMAP_BLENDING_ADD";break}return e}function lp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function cp(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=rp(t),c=sp(t),u=ap(t),f=op(t),p=lp(t),m=jf(t),_=$f(s),x=r.createProgram();let h,d,A=t.glslVersion?"#version "+t.glslVersion+`
...
Program Info Log: `+k+`
`+J+`
`+G)}else k!==""?console.warn("THREE.WebGLProgram: Program Info Log:",k):(z===""||Z==="")&&(V=!1);V&&(M.diagnostics={runnable:Q,programLog:k,vertexShader:{log:z,prefix:h},fragmentShader:{log:Z,prefix:d}})}r.deleteShader(B),r.deleteShader(L),O=new wr(r,x),ie=Jf(r,x)}let O;this.getUniforms=function(){return O===void 0&&b(this),O};let ie;this.getAttributes=function(){return ie===void 0&&b(this),ie};let g=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return g===!1&&(g=r.getProgramParameter(x,Vf)),g},this.destroy=function(){n.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Wf++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=B,this.fragmentShader=L,this}let up=0;class hp{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new dp(e),t.set(e,n)),n}}class dp{constructor(e){this.id=up++,this.code=e,this.usedTimes=0}}function fp(i,e,t,n,r,s,o){const a=new _l,l=new hp,c=new Set,u=[],f=r.logarithmicDepthBuffer,p=r.reverseDepthBuffer,m=r.vertexTextures;let _=r.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function h(g){return c.add(g),g===0?"uv":`uv${g}`}function d(g,M,k,z,Z){const Q=z.fog,V=Z.geometry,J=g.isMeshStandardMaterial?z.environment:null,G=(g.isMeshStandardMaterial?t:e).get(g.envMap||J),fe=G&&G.mapping===Fr?G.image.height:null,pe=x[g.type];g.precision!==null&&(_=r.getMaxPrecision(g.precision),_!==g.precision&&console.warn("THREE.WebGLProgram.getParameters:",g.precision,"not supported, using",_,"instead."));const ve=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Ve=ve!==void 0?ve.length:0;let Xe=0;V.morphAttributes.position!==void 0&&(Xe=1),V.morphAttributes.normal!==void 0&&(Xe=2),V.morphAttributes.color!==void 0&&(Xe=3);let X,te,_e,me;if(pe){const Ct=tn[pe];X=Ct.vertexShader,te=Ct.fragmentShader}else X=g.vertexShader,te=g.fragmentShader,l.update(g),_e=l.getVertexShaderID(g),me=l.getFragmentShaderID(g);const Ue=i.getRenderTarget(),be=Z.isInstancedMesh===!0,ze=Z.isBatchedMesh===!0,Ze=!!g.map,Ge=!!g.matcap,R=!!G,vt=!!g.aoMap,Oe=!!g.lightMap,ke=!!g.bumpMap,we=!!g.normalMap,Qe=!!g.displacementMap,Re=!!g.emissiveMap,y=!!g.metalnessMap,v=!!g.roughnessMap,I=g.anisotropy>0,q=g.clearcoat>0,ee=g.dispersion>0,Y=g.iridescence>0,xe=g.sheen>0,oe=g.transmission>0,w=I&&!!g.anisotropyMap,re=q&&!!g.clearcoatMap,j=q&&!!g.clearcoatNormalMap,se=q&&!!g.clearcoatRoughnessMap,Me=Y&&!!g.iridescenceMap,Te=Y&&!!g.iridescenceThicknessMap,ue=xe&&!!g.sheenColorMap,Be=xe&&!!g.sheenRoughnessMap,Ae=!!g.specularMap,He=!!g.specularColorMap,C=!!g.specularIntensityMap,he=oe&&!!g.transmissionMap,H=oe&&!!g.thicknessMap,$=!!g.gradientMap,le=!!g.alphaMap,de=g.alphaTest>0,We=!!g.alphaHash,ht=!!g.extensions;let Rt=wn;g.toneMapped&&(Ue===null||Ue.isXRRenderTarget===!0)&&(Rt=i.toneMapping);const Ye={shaderID:pe,shaderType:g.type,shaderName:g.name,vertexShader:X,fragmentShader:te,defines:g.defines,customVertexShaderID:_e,customFragmentShaderID:me,isRawShaderMaterial:g.isRawShaderMaterial===!0,glslVersion:g.glslVersion,precision:_,batching:ze,batchingColor:ze&&Z._colorsTexture!==null,instancing:be,instancingColor:be&&Z.instanceColor!==null,instancingMorph:be&&Z.morphTexture!==null,supportsVertexTextures:m,outputColorSpace:Ue===null?i.outputColorSpace:Ue.isXRRenderTarget===!0?Ue.texture.colorSpace:Cn,alphaToCoverage:!!g.alphaToCoverage,map:Ze,matcap:Ge,envMap:R,envMapMode:R&&G.mapping,envMapCubeUVHeight:fe,aoMap:vt,lightMap:Oe,bumpMap:ke,normalMap:we,displacementMap:m&&Qe,emissiveMap:Re,normalMapObjectSpace:we&&g.normalMapType===xc,normalMapTangentSpace:we&&g.normalMapType===vc,metalnessMap:y,roughnessMap:v,anisotropy:I,anisotropyMap:w,clearcoat:q,clearcoatMap:re,clearcoatNormalMap:j,clearcoatRoughnessMap:se,dispersion:ee,iridescence:Y,iridescenceMap:Me,iridescenceThicknessMap:Te,sheen:xe,sheenColorMap:ue,sheenRoughnessMap:Be,specularMap:Ae,specularColorMap:He,specularIntensityMap:C,transmission:oe,transmissionMap:he,thicknessMap:H,gradientMap:$,opaque:g.transparent===!1&&g.blending===fi&&g.alphaToCoverage===!1,alphaMap:le,alphaTest:de,alphaHash:We,combine:g.combine,mapUv:Ze&&h(g.map.channel),aoMapUv:vt&&h(g.aoMap.channel),lightMapUv:Oe&&h(g.lightMap.channel),bumpMapUv:ke&&h(g.bumpMap.channel),normalMapUv:we&&h(g.normalMap.channel),displacementMapUv:Qe&&h(g.displacementMap.channel),emissiveMapUv:Re&&h(g.emissiveMap.channel),metalnessMapUv:y&&h(g.metalnessMap.channel),roughnessMapUv:v&&h(g.roughnessMap.channel),anisotropyMapUv:w&&h(g.anisotropyMap.channel),clearcoatMapUv:re&&h(g.clearcoatMap.channel),clearcoatNormalMapUv:j&&h(g.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:se&&h(g.clearcoatRoughnessMap.channel),iridescenceMapUv:Me&&h(g.iridescenceMap.channel),iridescenceThicknessMapUv:Te&&h(g.iridescenceThicknessMap.channel),sheenColorMapUv:ue&&h(g.sheenColorMap.channel),sheenRoughnessMapUv:Be&&h(g.sheenRoughnessMap.channel),specularMapUv:Ae&&h(g.specularMap.channel),specularColorMapUv:He&&h(g.specularColorMap.channel),specularIntensityMapUv:C&&h(g.specularIntensityMap.channel),transmissionMapUv:he&&h(g.transmissionMap.channel),thicknessMapUv:H&&h(g.thicknessMap.channel),alphaMapUv:le&&h(g.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(we||I),vertexColors:g.vertexColors,vertexAlphas:g.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:Z.isPoints===!0&&!!V.attributes.uv&&(Ze||le),fog:!!Q,useFog:g.fog===!0,fogExp2:!!Q&&Q.isFogExp2,flatShading:g.flatShading===!0,sizeAttenuation:g.sizeAttenuation===!0,logarithmicDepthBuffer:f,reverseDepthBuffer:p,skinning:Z.isSkinnedMesh===!0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:Ve,morphTextureStride:Xe,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:g.dithering,shadowMapEnabled:i.shadowMap.enabled&&k.length>0,shadowMapType:i.shadowMap.type,toneMapping:Rt,decodeVideoTexture:Ze&&g.map.isVideoTexture===!0&&$e.getTransfer(g.map.colorSpace)===tt,premultipliedAlpha:g.premultipliedAlpha,doubleSided:g.side===dn,flipSided:g.side===Dt,useDepthPacking:g.depthPacking>=0,depthPacking:g.depthPacking||0,index0AttributeName:g.index0AttributeName,extensionClipCullDistance:ht&&g.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ht&&g.extensions.multiDraw===!0||ze)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:g.customProgramCacheKey()};return Ye.vertexUv1s=c.has(1),Ye.vertexUv2s=c.has(2),Ye.vertexUv3s=c.has(3),c.clear(),Ye}function A(g){const M=[];if(g.shaderID?M.push(g.shaderID):(M.push(g.customVertexShaderID),M.push(g.customFragmentShaderID)),g.defines!==void 0)for(const k in g.defines)M.push(k),M.push(g.defines[k]);return g.isRawShaderMaterial===!1&&(E(M,g),T(M,g),M.push(i.outputColorSpace)),M.push(g.customProgramCacheKey),M.join()}function E(g,M){g.push(M.precision),g.push(M.outputColorSpace),g.push(M.envMapMode),g.push(M.envMapCubeUVHeight),g.push(M.mapUv),g.push(M.alphaMapUv),g.push(M.lightMapUv),g.push(M.aoMapUv),g.push(M.bumpMapUv),g.push(M.normalMapUv),g.push(M.displacementMapUv),g.push(M.emissiveMapUv),g.push(M.metalnessMapUv),g.push(M.roughnessMapUv),g.push(M.anisotropyMapUv),g.push(M.clearcoatMapUv),g.push(M.clearcoatNormalMapUv),g.push(M.clearcoatRoughnessMapUv),g.push(M.iridescenceMapUv),g.push(M.iridescenceThicknessMapUv),g.push(M.sheenColorMapUv),g.push(M.sheenRoughnessMapUv),g.push(M.specularMapUv),g.push(M.specularColorMapUv),g.push(M.specularIntensityMapUv),g.push(M.transmissionMapUv),g.push(M.thicknessMapUv),g.push(M.combine),g.push(M.fogExp2),g.push(M.sizeAttenuation),g.push(M.morphTargetsCount),g.push(M.morphAttributeCount),g.push(M.numDirLights),g.push(M.numPointLights),g.push(M.numSpotLights),g.push(M.numSpotLightMaps),g.push(M.numHemiLights),g.push(M.numRectAreaLights),g.push(M.numDirLightShadows),g.push(M.numPointLightShadows),g.push(M.numSpotLightShadows),g.push(M.numSpotLightShadowsWithMaps),g.push(M.numLightProbes),g.push(M.shadowMapType),g.push(M.toneMapping),g.push(M.numClippingPlanes),g.push(M.numClipIntersection),g.push(M.depthPacking)}function T(g,M){a.disableAll(),M.supportsVertexTextures&&a.enable(0),M.instancing&&a.enable(1),M.instancingColor&&a.enable(2),M.instancingMorph&&a.enable(3),M.matcap&&a.enable(4),M.envMap&&a.enable(5),M.normalMapObjectSpace&&a.enable(6),M.normalMapTangentSpace&&a.enable(7),M.clearcoat&&a.enable(8),M.iridescence&&a.enable(9),M.alphaTest&&a.enable(10),M.vertexColors&&a.enable(11),M.vertexAlphas&&a.enable(12),M.vertexUv1s&&a.enable(13),M.vertexUv2s&&a.enable(14),M.vertexUv3s&&a.enable(15),M.vertexTangents&&a.enable(16),M.anisotropy&&a.enable(17),M.alphaHash&&a.enable(18),M.batching&&a.enable(19),M.dispersion&&a.enable(20),M.batchingColor&&a.enable(21),g.push(a.mask),a.disableAll(),M.fog&&a.enable(0),M.useFog&&a.enable(1),M.flatShading&&a.enable(2),M.logarithmicDepthBuffer&&a.enable(3),M.reverseDepthBuffer&&a.enable(4),M.skinning&&a.enable(5),M.morphTargets&&a.enable(6),M.morphNormals&&a.enable(7),M.morphColors&&a.enable(8),M.premultipliedAlpha&&a.enable(9),M.shadowMapEnabled&&a.enable(10),M.doubleSided&&a.enable(11),M.flipSided&&a.enable(12),M.useDepthPacking&&a.enable(13),M.dithering&&a.enable(14),M.transmission&&a.enable(15),M.sheen&&a.enable(16),M.opaque&&a.enable(17),M.pointsUvs&&a.enable(18),M.decodeVideoTexture&&a.enable(19),M.alphaToCoverage&&a.enable(20),g.push(a.mask)}function B(g){const M=x[g.type];let k;if(M){const z=tn[M];k=Ur.clone(z.uniforms)}else k=g.uniforms;return k}function L(g,M){let k;for(let z=0,Z=u.length;z<Z;z++){const Q=u[z];if(Q.cacheKey===M){k=Q,++k.usedTimes;break}}return k===void 0&&(k=new cp(i,M,g,s),u.push(k)),k}function b(g){if(--g.usedTimes===0){const M=u.indexOf(g);u[M]=u[u.length-1],u.pop(),g.destroy()}}function O(g){l.remove(g)}function ie(){l.dispose()}return{getParameters:d,getProgramCacheKey:A,getUniforms:B,acquireProgram:L,releaseProgram:b,releaseShaderCache:O,programs:u,dispose:ie}}function pp(){let i=new WeakMap;function e(o){return i.has(o)}function t(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function r(o,a,l){i.get(o)[a]=l}function s(){i=new WeakMap}return{has:e,get:t,remove:n,update:r,dispose:s}}function mp(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function Ao(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function bo(){const i=[];let e=0;const t=[],n=[],r=[];function s(){e=0,t.length=0,n.length=0,r.length=0}function o(f,p,m,_,x,h){let d=i[e];return d===void 0?(d={id:f.id,object:f,geometry:p,material:m,groupOrder:_,renderOrder:f.renderOrder,z:x,group:h},i[e]=d):(d.id=f.id,d.object=f,d.geometry=p,d.material=m,d.groupOrder=_,d.renderOrder=f.renderOrder,d.z=x,d.group=h),e++,d}function a(f,p,m,_,x,h){const d=o(f,p,m,_,x,h);m.transmission>0?n.push(d):m.transparent===!0?r.push(d):t.push(d)}function l(f,p,m,_,x,h){const d=o(f,p,m,_,x,h);m.transmission>0?n.unshift(d):m.transparent===!0?r.unshift(d):t.unshift(d)}function c(f,p){t.length>1&&t.sort(f||mp),n.length>1&&n.sort(p||Ao),r.length>1&&r.sort(p||Ao)}function u(){for(let f=e,p=i.length;f<p;f++){const m=i[f];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:n,transparent:r,init:s,push:a,unshift:l,finish:u,sort:c}}function _p(){let i=new WeakMap;function e(n,r){const s=i.get(n);let o;return s===void 0?(o=new bo,i.set(n,[o])):r>=s.length?(o=new bo,s.push(o)):o=s[r],o}function t(){i=new WeakMap}return{get:e,dispose:t}}function gp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new U,color:new De};break;case"SpotLight":t={position:new U,direction:new U,color:new De,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new U,color:new De,distance:0,decay:0};break;case"HemisphereLight":t={direction:new U,skyColor:new De,groundColor:new De};break;case"RectAreaLight":t={color:new De,position:new U,halfWidth:new U,halfHeight:new U};break}return i[e.id]=t,t}}}function vp(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Pe};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Pe};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Pe,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let xp=0;function Sp(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function Mp(i){const e=new gp,t=vp(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new U);const r=new U,s=new nt,o=new nt;function a(c){let u=0,f=0,p=0;for(let ie=0;ie<9;ie++)n.probe[ie].set(0,0,0);let m=0,_=0,x=0,h=0,d=0,A=0,E=0,T=0,B=0,L=0,b=0;c.sort(Sp);for(let ie=0,g=c.length;ie<g;ie++){const M=c[ie],k=M.color,z=M.intensity,Z=M.distance,Q=M.shadow&&M.shadow.map?M.shadow.map.texture:null;if(M.isAmbientLight)u+=k.r*z,f+=k.g*z,p+=k.b*z;else if(M.isLightProbe){for(let V=0;V<9;V++)n.probe[V].addScaledVector(M.sh.coefficients[V],z);b++}else if(M.isDirectionalLight){const V=e.get(M);if(V.color.copy(M.color).multiplyScalar(M.intensity),M.castShadow){const J=M.shadow,G=t.get(M);G.shadowIntensity=J.intensity,G.shadowBias=J.bias,G.shadowNormalBias=J.normalBias,G.shadowRadius=J.radius,G.shadowMapSize=J.mapSize,n.directionalShadow[m]=G,n.directionalShadowMap[m]=Q,n.directionalShadowMatrix[m]=M.shadow.matrix,A++}n.directional[m]=V,m++}else if(M.isSpotLight){const V=e.get(M);V.position.setFromMatrixPosition(M.matrixWorld),V.color.copy(k).multiplyScalar(z),V.distance=Z,V.coneCos=Math.cos(M.angle),V.penumbraCos=Math.cos(M.angle*(1-M.penumbra)),V.decay=M.decay,n.spot[x]=V;const J=M.shadow;if(M.map&&(n.spotLightMap[B]=M.map,B++,J.updateMatrices(M),M.castShadow&&L++),n.spotLightMatrix[x]=J.matrix,M.castShadow){const G=t.get(M);G.shadowIntensity=J.intensity,G.shadowBias=J.bias,G.shadowNormalBias=J.normalBias,G.shadowRadius=J.radius,G.shadowMapSize=J.mapSize,n.spotShadow[x]=G,n.spotShadowMap[x]=Q,T++}x++}else if(M.isRectAreaLight){const V=e.get(M);V.color.copy(k).multiplyScalar(z),V.halfWidth.set(M.width*.5,0,0),V.halfHeight.set(0,M.height*.5,0),n.rectArea[h]=V,h++}else if(M.isPointLight){const V=e.get(M);if(V.color.copy(M.color).multiplyScalar(M.intensity),V.distance=M.distance,V.decay=M.decay,M.castShadow){const J=M.shadow,G=t.get(M);G.shadowIntensity=J.intensity,G.shadowBias=J.bias,G.shadowNormalBias=J.normalBias,G.shadowRadius=J.radius,G.shadowMapSize=J.mapSize,G.shadowCameraNear=J.camera.near,G.shadowCameraFar=J.camera.far,n.pointShadow[_]=G,n.pointShadowMap[_]=Q,n.pointShadowMatrix[_]=M.shadow.matrix,E++}n.point[_]=V,_++}else if(M.isHemisphereLight){const V=e.get(M);V.skyColor.copy(M.color).multiplyScalar(z),V.groundColor.copy(M.groundColor).multiplyScalar(z),n.hemi[d]=V,d++}}h>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ae.LTC_FLOAT_1,n.rectAreaLTC2=ae.LTC_FLOAT_2):(n.rectAreaLTC1=ae.LTC_HALF_1,n.rectAreaLTC2=ae.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=f,n.ambient[2]=p;const O=n.hash;(O.directionalLength!==m||O.pointLength!==_||O.spotLength!==x||O.rectAreaLength!==h||O.hemiLength!==d||O.numDirectionalShadows!==A||O.numPointShadows!==E||O.numSpotShadows!==T||O.numSpotMaps!==B||O.numLightProbes!==b)&&(n.directional.length=m,n.spot.length=x,n.rectArea.length=h,n.point.length=_,n.hemi.length=d,n.directionalShadow.length=A,n.directionalShadowMap.length=A,n.pointShadow.length=E,n.pointShadowMap.length=E,n.spotShadow.length=T,n.spotShadowMap.length=T,n.directionalShadowMatrix.length=A,n.pointShadowMatrix.length=E,n.spotLightMatrix.length=T+B-L,n.spotLightMap.length=B,n.numSpotLightShadowsWithMaps=L,n.numLightProbes=b,O.directionalLength=m,O.pointLength=_,O.spotLength=x,O.rectAreaLength=h,O.hemiLength=d,O.numDirectionalShadows=A,O.numPointShadows=E,O.numSpotShadows=T,O.numSpotMaps=B,O.numLightProbes=b,n.version=xp++)}function l(c,u){let f=0,p=0,m=0,_=0,x=0;const h=u.matrixWorldInverse;for(let d=0,A=c.length;d<A;d++){const E=c[d];if(E.isDirectionalLight){const T=n.directional[f];T.direction.setFromMatrixPosition(E.matrixWorld),r.setFromMatrixPosition(E.target.matrixWorld),T.direction.sub(r),T.direction.transformDirection(h),f++}else if(E.isSpotLight){const T=n.spot[m];T.position.setFromMatrixPosition(E.matrixWorld),T.position.applyMatrix4(h),T.direction.setFromMatrixPosition(E.matrixWorld),r.setFromMatrixPosition(E.target.matrixWorld),T.direction.sub(r),T.direction.transformDirection(h),m++}else if(E.isRectAreaLight){const T=n.rectArea[_];T.position.setFromMatrixPosition(E.matrixWorld),T.position.applyMatrix4(h),o.identity(),s.copy(E.matrixWorld),s.premultiply(h),o.extractRotation(s),T.halfWidth.set(E.width*.5,0,0),T.halfHeight.set(0,E.height*.5,0),T.halfWidth.applyMatrix4(o),T.halfHeight.applyMatrix4(o),_++}else if(E.isPointLight){const T=n.point[p];T.position.setFromMatrixPosition(E.matrixWorld),T.position.applyMatrix4(h),p++}else if(E.isHemisphereLight){const T=n.hemi[x];T.direction.setFromMatrixPosition(E.matrixWorld),T.direction.transformDirection(h),x++}}}return{setup:a,setupView:l,state:n}}function wo(i){const e=new Mp(i),t=[],n=[];function r(u){c.camera=u,t.length=0,n.length=0}function s(u){t.push(u)}function o(u){n.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function Ep(i){let e=new WeakMap;function t(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new wo(i),e.set(r,[a])):s>=o.length?(a=new wo(i),o.push(a)):a=o[s],a}function n(){e=new WeakMap}return{get:t,dispose:n}}class yp extends zi{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=_c,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Tp extends zi{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Ap=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class lm{constructor(){W(this,"sharedUniforms",{u_blueNoiseTexture:{value:null},u_blueNoiseTexelSize:{value:null},u_blueNoiseCoordOffset:{value:new Pe}});W(this,"TEXTURE_SIZE",128)}preInit(){mn.loadTexture(ct.ASSETS_PATH+"textures/LDR_RGB1_0.png",e=>{e.generateMipmaps=!1,e.minFilter=e.magFilter=bt,e.wrapS=e.wrapT=Rr,e.needsUpdate=!0,this.sharedUniforms.u_blueNoiseTexture.value=e,this.sharedUniforms.u_blueNoiseTexelSize.value=new Pe(1/this.TEXTURE_SIZE,1/this.TEXTURE_SIZE)}),Ne.getBlueNoise=om}update(e){this.sharedUniforms.u_blueNoiseCoordOffset.value.set(Math.random(),Math.random())}}const Ei=new lm;class cm{constructor(){W(this,"PI",Math.PI)}clamp(e,t,n){return e<t?t:e>n?n:e}mix(e,t,n){return e+(t-e)*n}cUnMix(e,t,n){return this.clamp((n-e)/(t-e),0,1)}saturate(e){return this.clamp(e,0,1)}fit(e,t,n,r,s,o){return e=this.cUnMix(t,n,e),o&&(e=o(e)),r+e*(s-r)}}const gt=new cm;class um{quartInOut(e){return(e*=2)<1?.5*e*e*e*e:-.5*((e-=2)*e*e*e-2)}sineOut(e){return Math.sin(e*Math.PI/2)}}function hm(i,e,t,n,r){if(i===0)return 0;if(i===1)return 1;function s(l,c,u,f,p){const m=3*(u-c),_=3*(f-u)-m;return(((p-c-m-_)*l+_)*l+m)*l+c}function o(l,c,u,f=1e-6){let p=0,m=1,_=l;for(;p<m;){const x=s(_,0,c,u,1);if(Math.abs(x-l)<f)return _;x<l?p=_:m=_,_=(p+m)/2}return _}const a=o(i,e,n);return s(a,0,t,r,1)}function Hn(i){return hm(i,.3,0,0,1)}const Ho=new um,lt={NOT_STARTED:"not-started",STARTED:"started",FREE:"free",RESULT:"result",RESULT_ANIMATION:"result_animation",RESTART_ANIMATION:"restart_animation",RESTART:"restart"},mr=Object.values(lt),ut={NONE:"none",PAUSE:"pause",STOP:"stop",COMPLETED:"completed",FAILED:"failed"};class dm{constructor(){W(this,"statusIndex",0);W(this,"status",mr[this.statusIndex]);W(this,"result",ut.NONE);W(this,"stateSignal",new hi);W(this,"spawnSignal",new hi);W(this,"endCycleSignal",new hi);W(this,"gameEndedSignal",new hi);W(this,"statusUpdateQueue",[])}init(){this.updateFlags()}updateAfterCycle(){this.isStart?this.setFree():this.isResult&&this.setResultAnimation();const e=this.statusUpdateQueue.shift();e==null||e()}updateFlags(){this.hasNotStarted=this.status===lt.NOT_STARTED,this.isStart=this.status===lt.STARTED,this.isFree=this.status===lt.FREE,this.isResult=this.status===lt.RESULT,this.isResultAnimation=this.status===lt.RESULT_ANIMATION,this.isRestartAnimation=this.status===lt.RESTART_ANIMATION,this.isRestart=this.status===lt.RESTART,this.isSuccessResult=(this.isResult||this.isResultAnimation)&&this.result===ut.COMPLETED,this.isFailResult=(this.isResult||this.isResultAnimation)&&this.result===ut.FAILED,this.isPaused=(this.isResult||this.isResultAnimation)&&this.result===ut.PAUSE,this.isStopped=(this.isResult||this.isResultAnimation)&&this.result===ut.STOP}_updateStatus(e,t=!1){if(!K.showVisual)return!1;const n=mr.indexOf(e);return(this.statusIndex+1)%mr.length===n?(this.statusIndex=n,this.status=mr[this.statusIndex],t||(this.updateFlags(),this.stateSignal.dispatch(this.status,this.result)),!0):!1}_updateStatusAndResult(e,t){this._updateStatus(e,!0)&&(this.result=t,this.updateFlags(),this.stateSignal.dispatch(this.status,this.result))}set(e){var n;(n={start:this.setStart,free:this.setFree,pause:this.setPause,resume:this.setResume,stop:this.setStop,complete:this.setComplete,success:this.setComplete,fail:this.setFail,resultAnimation:this.setResultAnimation,restartAnimation:this.setRestartAnimation,restart:this.setRestart,showVisual:this.showVisual}[e])==null||n.call(this)}showVisual(){K.showVisual=!0}_queueStatusUpdate(e,t=null){this.statusUpdateQueue.push(()=>t?this._updateStatusAndResult(e,t):this._updateStatus(e))}reset(){this._queueStatusUpdate(lt.NOT_STARTED,ut.NONE)}setStart(){this._queueStatusUpdate(lt.STARTED)}setFree(){this._queueStatusUpdate(lt.FREE)}setPause(){K.isPaused=!0}setResume(){K.isPaused=!1}setStop(){this._queueStatusUpdate(lt.RESULT,ut.STOP)}setComplete(){this._queueStatusUpdate(lt.RESULT,ut.COMPLETED)}setFail(){this._queueStatusUpdate(lt.RESULT,ut.FAILED)}setResultAnimation(){this._queueStatusUpdate(lt.RESULT_ANIMATION)}setRestartAnimation(){this._queueStatusUpdate(lt.RESTART_ANIMATION)}setRestart(){this.statusUpdateQueue.push(()=>{this._updateStatus(lt.RESTART)&&this.gameEndedSignal.dispatch()})}}const Ie=new dm,Go=(i,e)=>Math.hypot(i,e);class fm{constructor(e=0,t=0,n=0){this.id=e,this.row=t,this.col=n,this.distance=Go(t,n),this.MAX_DISTANCE=Go(Vt,Vt),this.priority=this.MAX_DISTANCE-this.distance,this.ringIndex=Math.floor(this.distance),this.isMain=t===0&&n===0,this.isBorder=Math.abs(t)===2||Math.abs(n)===2,this.isOccupied=!1,this.willBeOccupied=!1,this.activeRatio=0,this.neighbours=null,this.reachableNeighbours=null,this.prioritySortedReachableNeighbours=null,this.randomDelay=Math.random()*.5+(this.MAX_DISTANCE-this.priority)*.5}init(){this.reachableNeighbours=this.neighbours.filter(e=>e.row===this.row||e.col===this.col),this._sortPriorityNeighbours()}_sortPriorityNeighbours(){this.prioritySortedReachableNeighbours=[...this.reachableNeighbours].sort((e,t)=>e.priority-t.priority)}shuffleReachableNeighbours(){for(let e=this.reachableNeighbours.length-1;e>0;e--){const t=Math.floor(Math.random()*(e+1));[this.reachableNeighbours[e],this.reachableNeighbours[t]]=[this.reachableNeighbours[t],this.reachableNeighbours[e]]}this._sortPriorityNeighbours()}reset(){this.isOccupied=!1,this.willBeOccupied=!1,this.activeRatio=0}update(e){}}const Tt=5,Vt=Math.floor(Tt/2),Lt=Tt*Tt;class pm{constructor(){W(this,"tiles",[]);W(this,"mainTile",null)}init(){this.tiles=Array.from({length:Tt},(e,t)=>Array.from({length:Tt},(n,r)=>{const s=t-Vt,o=r-Vt;return new fm(t*Tt+r,s,o)})),this.tiles.forEach((e,t)=>e.forEach((n,r)=>{n.neighbours=this._getNeighbouringTiles(t-Vt,r-Vt),n.init()})),this.mainTile=this.getTile(0,0)}getTile(e,t){var n;return((n=this.tiles[e+Vt])==null?void 0:n[t+Vt])||null}getRandomFreeTile(){const e=this.tiles.flat().filter(t=>!t.isOccupied);return e.length?e[Math.floor(Math.random()*e.length)]:null}_getNeighbouringTiles(e,t){return[-1,0,1].flatMap(n=>[-1,0,1].map(r=>n===0&&r===0?null:this.getTile(e+n,t+r)).filter(Boolean))}reset(){this.tiles.flat().forEach(e=>e.reset())}update(e){this.tiles.flat().forEach(t=>t.update(e))}}const nn=new pm;class ko{constructor(e){W(this,"id",-1);W(this,"isMoving",!1);W(this,"hasBeenSpawned",!1);W(this,"hasAnimationEnded",!1);W(this,"hasBeenEvaluated",!1);W(this,"currentTile",null);W(this,"targetTile",null);W(this,"moveAnimationRatio",0);W(this,"spawnAnimationRatio",0);W(this,"spawnAnimationRatioUnclamped",-Math.random());W(this,"easedAnimationRatio",0);W(this,"randomVector",{x:Math.random()-.5,y:Math.random()-.5});W(this,"lifeCycle",0);W(this,"easingFunction",null);this.id=e,this.init()}init(){this._setNewEasingFunction()}_setNewEasingFunction(){const e=Math.random(),t=.25;this.easingFunction=n=>Hn(gt.fit(n,e*t,e*t+(1-t),0,1))}updateTile(){this.currentTile&&(this.currentTile.isOccupied=!0,this.currentTile.willBeOccupied=!1)}_findBestTile(e,t){return e.find(n=>n.isOccupied||n.willBeOccupied||n.isMain?!1:t||this.currentTile.priority>=n.priority)}moveToNextTile(e=!1,t=0){if(this.hasBeenEvaluated=!0,this.moveAnimationRatio=-t,!this.currentTile)return;this.currentTile.shuffleReachableNeighbours();const n=e?this.currentTile.reachableNeighbours:this.currentTile.prioritySortedReachableNeighbours,r=this._findBestTile(n,e);r&&(!this.currentTile.isMain||Math.random()<=.8)?(this.targetTile=r,this.targetTile.willBeOccupied=!0,this.isMoving=!0):this.hasAnimationEnded=!0}resetAfterCycle(){this.hasBeenEvaluated=!1,this.hasAnimationEnded=!1,this.moveAnimationRatio=0,this.easedAnimationRatio=0,this.isMoving=!1,this.lifeCycle++,this._setNewEasingFunction(),this.updateTile()}reset(){this.id=-1,this.isMoving=!1,this.hasBeenSpawned=!1,this.hasAnimationEnded=!1,this.hasBeenEvaluated=!1,this.currentTile=null,this.targetTile=null,this.moveAnimationRatio=0,this.spawnAnimationRatio=0,this.spawnAnimationRatioUnclamped=-Math.random(),this.easedAnimationRatio=0,this.lifeCycle=0}_onMovementEnd(){this.moveAnimationRatio=1,this.currentTile&&(this.currentTile.isOccupied=!1),this.currentTile=this.targetTile,this.targetTile=null,this.hasAnimationEnded=!0,this.updateTile()}_updateSpawnAnimation(e){this.spawnAnimationRatioUnclamped+=.75*(K.animationSpeed-1)*e,this.spawnAnimationRatio=Math.max(0,Math.min(1,this.spawnAnimationRatioUnclamped)),this.spawnAnimationRatio===1&&(this.hasBeenSpawned=!0)}_updateMovement(e){(this.isMoving&&!this.hasAnimationEnded||Ie.isResultAnimation)&&(this.moveAnimationRatio=Math.min(1,this.moveAnimationRatio+(K.animationSpeed-1)*e),this.easedAnimationRatio=this.easingFunction(Math.max(0,this.moveAnimationRatio)),this.easedAnimationRatio===1&&(Ie.isFree||Ie.isResult)&&this._onMovementEnd())}_updateTileRatios(){const e=Math.max(0,Math.min(1,this.hasBeenSpawned?this.easedAnimationRatio:this.spawnAnimationRatio));this.currentTile&&(this.currentTile.activeRatio=this.hasBeenSpawned?this.targetTile?1-e:1:this.spawnAnimationRatio),this.targetTile&&(this.targetTile.activeRatio=e)}update(e){this.hasBeenSpawned?this._updateMovement(e):this._updateSpawnAnimation(e),this._updateTileRatios()}}class mm{constructor(){W(this,"blocks",[]);W(this,"lastSpawnedBlock",null);W(this,"cycleIndex",0);W(this,"animationSpeedRatio",0);W(this,"restartAnimationRatio",0);W(this,"firstStartAnimationRatio",0);W(this,"failShakeAnimationRatio",0);W(this,"endSpawnAnimationRatio",0);W(this,"endSpawnAnimationRatioUnclamped",-.1);W(this,"endFloatingAnimationRatio",0);W(this,"endFloatingAnimationRatioUnclamped",0);W(this,"endAnimationRatio",0);W(this,"endCoinsAnimationRatio",0);W(this,"previousSuccessBlocksAnimationRatio",0);W(this,"wasSuccess",!1)}init(){Ie.init(),nn.init()}_spawnBlock(){this._shouldPreventSpawn()||(Ie.isSuccessResult?this._spawnMultipleBlocks():this._spawnSingleBlock(),Ie.spawnSignal.dispatch())}_shouldPreventSpawn(){return Ie.isFailResult||Ie.isStopped||this.blocks.length>=Lt||this.blocks.length===Lt-5&&Ie.isFree||nn.mainTile.isOccupied&&!Ie.isSuccessResult}_spawnMultipleBlocks(){const e=Lt-K.activeBlocksCount;for(let t=0;t<e;t++){const n=nn.getRandomFreeTile();if(n){const r=new ko(this.blocks.length);r.currentTile=n,r.init(),r.updateTile(),this.blocks=[r,...this.blocks]}}}_spawnSingleBlock(){const e=new ko(this.blocks.length);e.currentTile=nn.mainTile,this.lastSpawnedBlock=e,e.init(),e.updateTile()}_startNewCycle(){Ie.updateAfterCycle(),![lt.NOT_STARTED,lt.RESTART_ANIMATION,lt.RESTART,lt.STARTED].includes(Ie.status)&&(this.lastSpawnedBlock&&(this.blocks=[this.lastSpawnedBlock,...this.blocks],this.lastSpawnedBlock=null),K.activeBlocksCount=this.blocks.length,!(Ie.isFailResult||Ie.isStopped)&&(this.blocks.forEach(e=>e.resetAfterCycle()),Ie.endCycleSignal.dispatch(),this.cycleIndex++,this._spawnBlock(),this._calculatePaths()))}_calculatePaths(){var e;(e=this.lastSpawnedBlock)!=null&&e.hasBeenSpawned&&this.lastSpawnedBlock.moveToNextTile(Ie.isFree,0),this.blocks.forEach((t,n)=>{!t.hasBeenEvaluated&&t.hasBeenSpawned&&t.moveToNextTile(Ie.isFree,n*.2)})}reset(){this.blocks.forEach(t=>t.reset()),di.reset(),nn.reset(),this.blocks=[],this.lastSpawnedBlock=null,this.cycleIndex=0,this.animationSpeedRatio=0,this.failShakeAnimationRatio=0,this.endAnimationRatio=0,this.endSpawnAnimationRatio=0,this.endSpawnAnimationRatioUnclamped=-.1,this.endFloatingAnimationRatio=0,this.endFloatingAnimationRatioUnclamped=0,this.restartAnimationRatio=0,this.endCoinsAnimationRatio=0,this.previousSuccessBlocksAnimationRatio=this.wasSuccess?.3:0;const e=ct.AUTO_RESTART&&[ut.FAILED,ut.COMPLETED].includes(Ie.result);Ie.reset(),this._startNewCycle(),e&&(Ie.setStart(),Ie.updateFlags())}_updateAnimationRatios(e){const{isResult:t,isResultAnimation:n,result:r}=Ie,s=r===ut.COMPLETED,o=r===ut.FAILED;this.firstStartAnimationRatio=gt.saturate(this.firstStartAnimationRatio+e*(K.showVisual?1:0)),this.animationSpeedRatio=Math.min(1,this.animationSpeedRatio+e*(t?1:0)),this.failShakeAnimationRatio=gt.saturate(this.failShakeAnimationRatio+(o?2:1e4)*e*(n?1:0)),this.endSpawnAnimationRatioUnclamped+=3*e*(this.failShakeAnimationRatio===1?1:0),this.endSpawnAnimationRatio=gt.saturate(this.endSpawnAnimationRatioUnclamped),this.endFloatingAnimationRatioUnclamped+=(s?.75:1e4)*e*(this.endSpawnAnimationRatio===1?1:0),this.endFloatingAnimationRatio=gt.saturate(this.endFloatingAnimationRatioUnclamped-1);const a=s?this.endFloatingAnimationRatio>.01:this.endSpawnAnimationRatio>.5;this.endAnimationRatio=gt.saturate(this.endAnimationRatio+(s?1e4:.75)*e*(a?1:0)),this.restartAnimationRatio=Math.min(1,this.restartAnimationRatio+.7*e*(this.endAnimationRatio>.1?1:0)),this.endCoinsAnimationRatio=s?gt.saturate(this.endCoinsAnimationRatio+.3*e*(this.restartAnimationRatio>.1?1:0)):0,this.previousSuccessBlocksAnimationRatio=gt.saturate(this.previousSuccessBlocksAnimationRatio-.25*e)}_checkCycleCompletion(){let e=!0;return this.lastSpawnedBlock&&(e=e&&this.lastSpawnedBlock.hasBeenSpawned),this.blocks.forEach(t=>{t.lifeCycle>0?e=e&&t.hasBeenEvaluated&&t.hasAnimationEnded:e=e&&t.spawnAnimationRatio===1}),e||Ie.isResultAnimation||Ie.isFailResult||Ie.isStopped}update(e){if(this._updateAnimationRatios(e),Ie.hasNotStarted){this._startNewCycle();return}if(Ie.isRestart){this.wasSuccess=Ie.result===ut.COMPLETED,this.reset();return}if(this.restartAnimationRatio===1&&(Ie.result!==ut.COMPLETED||this.endCoinsAnimationRatio>.75)){Ie.setRestart(),this._startNewCycle();return}Ie.isResultAnimation&&this.blocks.every(()=>this.endAnimationRatio===1)&&Ie.setRestartAnimation(),this.lastSpawnedBlock&&this.lastSpawnedBlock.update(e),this.blocks.forEach(n=>n.update(e)),nn.update(e),this._checkCycleCompletion()&&this._startNewCycle()}}const qe=new mm,_m=Math.PI/2,Vo=new U;class gm{constructor(){this.animation=0,this.boardDir=new Pe,this.boardPos=new Pe,this.pos=new U,this.orient=new Jt,this.showRatio=0,this.spinPivot=new U,this.spinOrient=new Jt}reset(){this.animation=0,this.boardDir.set(0,0),this.boardPos.set(0,0),this.pos.set(0,0,0),this.orient.identity(),this.showRatio=0,this.spinPivot.set(0,0,0),this.spinOrient.identity()}update(e){this.pos.set(this.boardPos.x,0,-this.boardPos.y),this.spinPivot.set(this.boardDir.x*.5,-.5,-this.boardDir.y*.5),Vo.set(-this.boardDir.y,0,-this.boardDir.x),this.spinOrient.setFromAxisAngle(Vo,this.animation*_m)}}var _r=`#ifndef IS_BASE
...
}`,Wo=`uniform vec3 u_lightPosition;
uniform sampler2D u_infoTexture;
uniform sampler2D u_infoTextureLinear;
...
void main() {
	...
	float fragCoordZ = 0.5 * vHighPrecisionZW[0] / vHighPrecisionZW[1] + 0.5;
    gl_FragColor = packDepthToRGBA( fragCoordZ );
}`;const Di=2*Lt,un=new Pe,gr=new Pe,vr=new U,Yo=new U,Ts=new Jt,qo=new Jt,Zo=new De,Ko=new De,jo=new De,xr=new De,On=new De;class vm{constructor(){W(this,"container",new ft);W(this,"_baseMesh");W(this,"_blocksMesh");W(this,"_blockList",[]);W(this,"_blockRenderList",[]);W(this,"_blockUpdateRange",{start:0,count:0});W(this,"sharedUniforms",{u_lightPosition:{value:new U(-2,6,-4)},u_goboTexture:{value:null},u_goboIntensity:{value:0},u_infoTexture:{value:null},u_infoTextureLinear:{value:null},u_restartAnimationRatio:{value:0},u_endAnimationRatio:{value:0}});W(this,"successColorRatio",0);W(this,"infoTexture",null)}preload(){this._blockList=Array(Di).fill().map(()=>new gm),this._blockRenderList=[...this._blockList],mn.loadBuf(ct.ASSETS_PATH+"models/BASE.buf",e=>{this._onBaseBlocksLoaded(e)}),mn.loadBuf(ct.ASSETS_PATH+"models/BOX.buf",e=>{this._onBoxLoaded(e)}),mn.loadBuf(ct.ASSETS_PATH+"models/lose_animation.buf",e=>{const{position:t,orient:n}=e.attributes;this.animationTotalFrames=t.count/Lt,this.loseAnimationPositionArray=t.array,this.loseAnimationOrientArray=n.array}),mn.loadTexture(ct.ASSETS_PATH+"textures/gobo.jpg",e=>{e.flipY=!1,e.needsUpdate=!0,this.sharedUniforms.u_goboTexture.value=e})}_onBaseBlocksLoaded(e){const t=new wt({uniforms:{...Ur.merge([ae.lights]),...K.sharedUniforms,...this.sharedUniforms,...Ei.sharedUniforms,u_color:{value:new De(this.neutralColor)},u_blocksColor:{value:new De},u_yDisplacement:{value:0},u_prevSuccessColor:{value:new De(K.successColor).convertSRGBToLinear()},u_successColor:{value:new De(K.successColor).convertSRGBToLinear()},u_successAnimationRatio:{value:0}},vertexShader:_r,fragmentShader:Wo,lights:!0,transparent:!0});this._baseMesh=new zt(e,t),this._baseMesh.receiveShadow=this._baseMesh.castShadow=!0,this._baseMesh.frustumCulled=!1,this._baseMesh.material.defines.IS_BASE=!0,this._baseMesh.customDepthMaterial=new wt({vertexShader:_r,fragmentShader:Xo,defines:{IS_DEPTH:!0,IS_BASE:!0}}),this.container.add(this._baseMesh)}_onBoxLoaded(e){const t=new Ll;t.index=e.index,Object.keys(e.attributes).forEach(s=>{t.setAttribute(s,e.attributes[s])}),t.instanceCount=Di;const n=(s,o)=>{const a=new Float32Array(Di*o);return t.setAttribute(s,new Cl(a,o).setUsage(wc)),a};this._instancePosArray=n("instancePos",3),this._instanceOrientArray=n("instanceOrient",4),this._instanceShowRatioArray=n("instanceShowRatio",1),this._instanceSpinPivotArray=n("instanceSpinPivot",3),this._instanceSpinOrientArray=n("instanceSpinOrient",4),this._instanceColorArray=n("instanceColor",3),this._instanceIsActiveArray=n("instanceIsActive",1),this._instanceNextDirectionArray=n("instanceNextDirection",2);const r=new wt({uniforms:{...Ur.merge([ae.lights]),...K.sharedUniforms,...this.sharedUniforms,...Ei.sharedUniforms},vertexShader:_r,fragmentShader:Wo,lights:!0});this._blocksMesh=new zt(t,r),this._blocksMesh.frustumCulled=!1,this._blocksMesh.castShadow=this._blocksMesh.receiveShadow=!0,this._blocksMesh.customDepthMaterial=new wt({uniforms:{...this.sharedUniforms},vertexShader:_r,fragmentShader:Xo,defines:{IS_DEPTH:!0}}),this.container.add(this._blocksMesh)}_onLoseAnimationLoaded(e){const{position:t,orient:n}=e.attributes;this.animationTotalFrames=t.count/Lt,this.loseAnimationPositionArray=t.array,this.loseAnimationOrientArray=n.array}init(){this.directLight=new Qp(16777215,1),this.directLight.castShadow=!0,this.directLight.shadow.camera.near=K.lightCameraNear,this.directLight.shadow.camera.far=K.lightCameraFar,this.directLight.shadow.camera.right=K.lightCameraSize,this.directLight.shadow.camera.left=-K.lightCameraSize,this.directLight.shadow.camera.top=K.lightCameraSize,this.directLight.shadow.camera.bottom=-K.lightCameraSize,this.directLight.shadow.bias=K.lightCameraBias,this.directLight.shadow.mapSize.width=768,this.directLight.shadow.mapSize.height=768,K.scene.add(this.directLight),K.scene.add(this.directLight.target),this.isShadowCameraHelperVisible=!1,this.shadowCameraHelper=new em(this.directLight.shadow.camera,1,"#ff0000"),K.lightCameraUpdateSignal.add(()=>{this.directLight.shadow.camera.updateProjectionMatrix(),this.shadowCameraHelper.update()}),K.lightCameraHelperSignal.add(()=>{this.isShadowCameraHelperVisible=!this.isShadowCameraHelperVisible,this.isShadowCameraHelperVisible?K.scene.add(this.shadowCameraHelper):K.scene.remove(this.shadowCameraHelper)}),this._assignFinalAnimationToTiles(),this.infoTexture=new Co(new Float32Array(Lt*4),Tt,Tt,Bt,jt),this.infoTextureLinear=new Co(new Float32Array(Lt*4),Tt,Tt,Bt,jt,fa,fn,fn,Ot,el,0),this.infoTextureLinear.generateMipmaps=!0,this.infoTextureLinear.needsUpdate=!0,this.sharedUniforms.u_infoTexture.value=this.infoTexture,this.sharedUniforms.u_infoTextureLinear.value=this.infoTextureLinear}_assignFinalAnimationToTiles(){nn.tiles.forEach((e,t)=>{e.forEach((n,r)=>{const s=t*Tt+r;n.loseAnimationPositionArray=new Float32Array(this.animationTotalFrames*3),n.loseAnimationOrientArray=new Float32Array(this.animationTotalFrames*4);for(let o=0;o<this.animationTotalFrames;o++){const a=(o*Lt+s)*3,l=(o*Lt+s)*4;n.loseAnimationPositionArray.set(this.loseAnimationPositionArray.subarray(a,a+3),o*3),n.loseAnimationOrientArray.set(this.loseAnimationOrientArray.subarray(l,l+4),o*4)}})})}reset(){this.successColorRatio=0,this._blockList.forEach(e=>e.reset())}_updateColors(e){Zo.set(K.mainColor),Ko.set(K.successColor),jo.set(K.failColor),xr.set(K.neutralColor),On.copy(Zo),Ie.isFailResult&&qe.endSpawnAnimationRatio===1&&On.copy(jo),Ie.result===ut.COMPLETED&&(this.successColorRatio=Math.min(1,this.successColorRatio+.5*e),On.lerp(Ko,this.successColorRatio)),Ie.result!==ut.COMPLETED&&On.lerp(xr,gt.saturate(qe.restartAnimationRatio)),xr.convertSRGBToLinear();for(let n=0;n<Di;n++){const r=n<qe.blocks.length+(qe.lastSpawnedBlock?1:0),s=r?On:xr;this._instanceColorArray.set([s.r,s.g,s.b],n*3),this._instanceIsActiveArray[n]=r?1:0}const t=this._baseMesh.material.uniforms;t.u_color.value.set(K.neutralColor).convertSRGBToLinear(),t.u_blocksColor.value.copy(On),t.u_prevSuccessColor.value.set(K.neutralColor),t.u_prevSuccessColor.value.lerp(On.set(K.successColor),qe.previousSuccessBlocksAnimationRatio),t.u_prevSuccessColor.value.convertSRGBToLinear()}_updateInfoTexture(){nn.tiles.forEach(e=>{e.forEach(t=>{let n=t.id*4;this.infoTexture.image.data[n+0]=this.infoTextureLinear.image.data[n+0]=t.activeRatio,this.infoTexture.image.data[n+1]=this.infoTextureLinear.image.data[n+1]=t.isOccupied||t.willBeOccupied?1:0,this.infoTexture.image.data[n+2]=this.infoTextureLinear.image.data[n+2]=t.isMain?1:0,this.infoTexture.image.data[n+3]=this.infoTextureLinear.image.data[n+3]=t.isBorder?1:0})}),this.infoTexture.needsUpdate=!0,this.infoTextureLinear.generateMipmaps=this.infoTextureLinear.needsUpdate=!0}_updateFreeBlocks(e){if(qe.lastSpawnedBlock){const t=this._blockList[qe.lastSpawnedBlock.id];t.boardPos.set(qe.lastSpawnedBlock.currentTile.row,qe.lastSpawnedBlock.currentTile.col),t.showRatio=Hn(gt.saturate(qe.lastSpawnedBlock.spawnAnimationRatioUnclamped))}qe.blocks.forEach(t=>{const n=this._blockList[t.id];n&&(n.showRatio=Hn(gt.saturate(t.spawnAnimationRatioUnclamped)),n.boardPos.set(t.currentTile.row,t.currentTile.col),t.targetTile&&n.boardDir.set(t.targetTile.row-t.currentTile.row,t.targetTile.col-t.currentTile.col),n.animation=t.hasAnimationEnded?0:t.easedAnimationRatio)})}_updateAttributes(e){for(let n=0;n<e;n++){const r=this._blockRenderList[n];r.pos.toArray(this._instancePosArray,n*3),r.orient.toArray(this._instanceOrientArray,n*4),this._instanceShowRatioArray[n]=Ho.quartInOut(r.showRatio),r.spinPivot.toArray(this._instanceSpinPivotArray,n*3),r.spinOrient.toArray(this._instanceSpinOrientArray,n*4),this._instanceNextDirectionArray.set([r.boardDir.x,r.boardDir.y],n*2)}const t=this._blocksMesh.geometry;for(const n in t.attributes){const r=t.attributes[n];r.isInstancedBufferAttribute&&(r.addUpdateRange(0,e*r.itemSize),r.needsUpdate=!0)}t.instanceCount=e}_updateStopAnimation(e,t){if(Ie.result===ut.STOP&&t>=Lt){const n=t-Lt,r=n%Tt-Vt,s=Math.floor(n/Tt)-Vt,o=nn.getTile(s,r);if(!o.isOccupied){const a=gt.saturate(qe.endSpawnAnimationRatioUnclamped-o.randomDelay);o.activeRatio=a,e.showRatio=Hn(a),e.boardPos.set(s,r)}}}_updateFailAnimation(e,t,n){if(Ie.result===ut.FAILED){if(e){const r=e.currentTile;if(qe.endAnimationRatio>0){const s=Math.floor(qe.endAnimationRatio*this.animationTotalFrames),o=Math.min(s+1,this.animationTotalFrames-1),a=qe.endAnimationRatio*this.animationTotalFrames-s;vr.fromArray(r.loseAnimationPositionArray,s*3),Yo.fromArray(r.loseAnimationPositionArray,o*3),vr.lerp(Yo,a),vr.y*=.5,t.pos.copy(vr),Ts.fromArray(r.loseAnimationOrientArray,s*4),qo.fromArray(r.loseAnimationOrientArray,o*4),Ts.slerp(qo,a),t.orient.copy(Ts)}if(qe.failShakeAnimationRatio>0){const s=gt.fit(qe.failShakeAnimationRatio,0,1,0,1,Ho.sineOut);if(un.set(r.row,r.col),un.normalize(),un.multiplyScalar(.1*s),t.pos.x+=un.x,t.pos.z-=un.y,qe.failShakeAnimationRatio<1){const o=s*gt.fit(qe.failShakeAnimationRatio,.5,.8,1,0);un.set(e.randomVector.x,e.randomVector.y),un.normalize(),un.multiplyScalar(o),gr.set(0,0),gr.addScaledVector(un,.08*o*Math.sin(o*40)),t.pos.x+=gr.x,t.pos.z+=gr.y}}}if(n>=Lt){const r=n-Lt,s=r%Tt-Vt,o=Math.floor(r/Tt)-Vt,a=nn.getTile(o,s),l=gt.saturate(qe.endSpawnAnimationRatioUnclamped-a.randomDelay);a.isOccupied||(a.activeRatio=l),t.showRatio=Hn(l),t.boardPos.set(o,s)}}}_updateFloatAnimation(e,t,n){if(Ie.result===ut.COMPLETED&&e){const s=.2*e.currentTile.randomDelay,o=qe.endFloatingAnimationRatioUnclamped-s;let a=gt.fit(o,0,.5,0,1,l=>1-Math.pow(1-l,5));a=gt.fit(o,.8,1,a,0,l=>Math.pow(l,5)),t.pos.y+=a}}update(e){this._updateFreeBlocks(e),this._updateColors(e);let t=0;for(let s=0;s<Di;s++){let o=this._blockList[s];o.update(e);let a=qe.blocks.filter(l=>l.id===s)[0];o.showRatio>0&&(this._blockRenderList[t++]=o),this._updateFailAnimation(a,o,s),this._updateStopAnimation(o,s),this._updateFloatAnimation(a,o,s)}this._updateInfoTexture(),this._updateAttributes(t);const n=Hn(qe.restartAnimationRatio),r=1-Hn(qe.firstStartAnimationRatio);this.container.position.y=-n-2*r,this.container.rotation.y=.5*Math.PI*r,this._baseMesh.material.uniforms.u_yDisplacement.value=-n-5*r,this._baseMesh.material.uniforms.u_successAnimationRatio.value=gt.fit(qe.endCoinsAnimationRatio,.025,.1,0,1),this.sharedUniforms.u_endAnimationRatio.value=Ie.result===ut.COMPLETED?qe.restartAnimationRatio:qe.endAnimationRatio,this.sharedUniforms.u_restartAnimationRatio.value=qe.restartAnimationRatio,this.sharedUniforms.u_goboIntensity.value=K.goboIntensity,this.sharedUniforms.u_lightPosition.value.set(K.lightPositionX,K.lightPositionY,K.lightPositionZ),this.directLight.position.copy(this.sharedUniforms.u_lightPosition.value),this.directLight.shadow.camera.near=K.lightCameraNear,this.directLight.shadow.camera.far=K.lightCameraFar,this.directLight.shadow.camera.right=K.lightCameraSize,this.directLight.shadow.camera.left=-K.lightCameraSize,this.directLight.shadow.camera.top=K.lightCameraSize,this.directLight.shadow.camera.bottom=-K.lightCameraSize,this.directLight.shadow.bias=K.lightCameraBias}}const di=new vm;var $o=`uniform float u_time;
...
void main() {
	float fragCoordZ = 0.5 * vHighPrecisionZW[0] / vHighPrecisionZW[1] + 0.5;
    gl_FragColor = packDepthToRGBA( fragCoordZ );
}`;class Mm{constructor(){W(this,"container",new ft);W(this,"coinMesh",null);W(this,"coinGeometry",null);W(this,"coinMaterial",null);W(this,"positionsArray",null);W(this,"orientArray",null);W(this,"curveuArray",null);W(this,"aoNArray",null);W(this,"aoPArray",null);W(this,"coinsCount",0);W(this,"animationRatio",0);W(this,"sharedUniforms",{u_time:{value:0},u_ratio:{value:0}})}preload(){mn.loadTexture(ct.ASSETS_PATH+"textures/matcap_gold.jpg",e=>{this.matcapTexture=e,this.matcapTexture.needsUpdate=!0}),mn.loadBuf(ct.ASSETS_PATH+"models/COIN.buf",e=>{this.refGeometry=e}),mn.loadBuf(ct.ASSETS_PATH+"models/COIN_PLACEMENT.buf",e=>{const{position:t,aoN:n,aoP:r,curveu:s,orient:o}=e.attributes;this.positionsArray=t.array,this.aoNArray=n.array,this.aoPArray=r.array,this.curveuArray=s.array,this.orientArray=o.array,this.coinsCount=t.count})}init(){this._setupGeometry(),this._setupMaterial(),this._setupMesh(),this.container.add(this.coinMesh)}_setupGeometry(){this.refGeometry.computeVertexNormals();const e=new Ll;e.index=this.refGeometry.index,Object.entries(this.refGeometry.attributes).forEach(([n,r])=>e.setAttribute(n,r)),this.randsArray=new Float32Array(this.coinsCount*3).map(()=>Math.random()*2-1),[["a_instancePosition",this.positionsArray,3],["a_instanceQuaternion",this.orientArray,4],["a_instanceCurveUV",this.curveuArray,1],["a_instanceAoN",this.aoNArray,3],["a_instanceAoP",this.aoPArray,3],["a_instanceRand",this.randsArray,3]].forEach(([n,r,s])=>{e.setAttribute(n,new Cl(r,s))}),this.coinGeometry=e}_setupMaterial(){this.coinMaterial=new wt({uniforms:{...di.sharedUniforms,...K.sharedUniforms,...this.sharedUniforms,...Ei.sharedUniforms,...Ur.merge([ae.lights]),u_matcapTexture:{value:this.matcapTexture}},vertexShader:$o,fragmentShader:xm,lights:!0})}_setupMesh(){this.coinMesh=new zt(this.coinGeometry,this.coinMaterial),this.coinMesh.frustumCulled=!1,this.coinMesh.castShadow=!0,this.coinMesh.receiveShadow=!0,this.coinMesh.customDepthMaterial=new wt({uniforms:{...this.sharedUniforms},vertexShader:$o,fragmentShader:Sm,defines:{IS_DEPTH:!0}})}update(e){this.animationRatio=qe.endCoinsAnimationRatio,this.sharedUniforms.u_ratio.value=this.animationRatio,this.sharedUniforms.u_time.value+=e,this.coinMesh.rotation.y=4*this.animationRatio,this.coinMesh.visible=this.animationRatio>0&&this.animationRatio<1}}const Sr=new Mm;var Em=`varying vec2 v_uv;

void main() {
    gl_Position = vec4(position.xy, 1.0, 1.0);
    v_uv = uv;
}`,ym=`uniform vec2 u_resolution;
uniform vec3 u_bgColor1;
uniform vec3 u_bgColor2;
...
}`;class Tm{constructor(){W(this,"container",new ft)}init(){const e=new wt({uniforms:Object.assign({u_resolution:K.sharedUniforms.u_resolution,u_bgColor1:K.sharedUniforms.u_bgColor1,u_bgColor2:K.sharedUniforms.u_bgColor2},Ei.sharedUniforms),vertexShader:Em,fragmentShader:ym});this.mesh=new zt(new Gi(2,2),e),this.mesh.renderOrder=1,this.container.add(this.mesh)}resize(){}}const Jo=new Tm;class Am{preload(e,t){ct.override(e),ct.WEBGL_OPTS.canvas=K.canvas=e.canvas,K.orbitTarget=e.orbitTarget,di.preload(),Sr.preload(),Ei.preInit(),K.renderer=new kp(ct.WEBGL_OPTS),mn.start(t)}init(){K.renderer.shadowMap.enabled=!0,K.renderer.shadowMap.type=da,K.scene=new Vp,K.camera=new ya(-1,1,1,-1,1,60),K.scene.add(K.camera),K.camera.position.fromArray(ct.DEFAULT_POSITION),K.orbitCamera=K.camera.clone();let e=K.orbitControls=new am(K.orbitCamera,K.orbitTarget);e.enableDamping=!0,e.enableDamping=!0,e.target0.fromArray(ct.DEFAULT_LOOKAT_POSITION),e.reset(),qe.init(),di.init(),Sr.init(),Jo.init(),K.scene.add(di.container),K.scene.add(Sr.container),K.scene.add(Jo.container)}setSize(e,t){K.viewportWidth=e,K.viewportHeight=t,K.viewportResolution.set(e,window.innerHeight);let n=e*ct.DPR,r=t*ct.DPR;if(ct.USE_PIXEL_LIMIT===!0&&n*r>ct.MAX_PIXEL_COUNT){let s=n/r;r=Math.sqrt(ct.MAX_PIXEL_COUNT/s),n=Math.ceil(r*s),r=Math.ceil(r)}K.width=n,K.height=r,K.resolution.set(n,r),K.camera.aspect=n/r,K.camera.updateProjectionMatrix(),K.renderer.setSize(n,r),K.canvas.style.width=`${e}px`,K.canvas.style.height=`${t}px`}render(e){K.isPaused&&(e*=0),K.time+=e,K.deltaTime=e,K.sharedUniforms.u_time.value=K.time,K.sharedUniforms.u_deltaTime.value=e;let t=K.sharedUniforms.u_bgColor1.value,n=K.sharedUniforms.u_bgColor2.value;t.set(K.bgColor1).convertSRGBToLinear(),n.set(K.bgColor2).convertSRGBToLinear();let r=K.viewportWidth,s=K.viewportHeight,o=K.cameraZoom*s/10,a=K.cameraOffsetX,l=K.cameraOffsetY;K.camera.zoom=o,K.camera.left=-r/2-a*r/o/2,K.camera.right=r/2-a*r/o/2,K.camera.top=s/2-l*s/o/2,K.camera.bottom=-s/2-l*s/o/2,K.camera.updateProjectionMatrix(),Ei.update(e),qe.update(e);let c=K.camera;K.orbitControls.update(),K.orbitCamera.updateMatrix(),K.orbitCamera.matrix.decompose(c.position,c.quaternion,c.scale),c.matrix.compose(c.position,c.quaternion,c.scale),di.update(e),Sr.update(e),K.renderer.setClearColor(K.bgColor,1),K.renderer.render(K.scene,K.camera)}}let Ti=new Am;Ti.properties=K;Ti.stateManager=Ie;Ti.STATUS=Ie.STATUS;Ti.RESULT=Ie.RESULT;Ti.setState=i=>{Ie.set(i)};window[ct.APP_ID]=Ti;
