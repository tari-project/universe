...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function yo(){return new yt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fa(),fragmentShader:`
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function To(){return new yt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fa(),fragmentShader:`
	...
	`}function $d(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Ys||l===qs,u=l===Ti||l===Ai;if(c||u){let f=e.get(a);const p=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==p)return t===null&&(t=new Mo(i)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),f.texture;if(f!==void 0)return f.texture;{const m=a.image;return c&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new Mo(i)),f=c?t.fromEquirectangular(a):t.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),a.addEventListener("dispose",s),f.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Jd(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Nr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function Qd(i,e,t,n){const r={},s=new WeakMap;function o(f){const p=f.target;p.index!==null&&e.remove(p.index);for(const _ in p.attributes)e.remove(p.attributes[_]);for(const _ in p.morphAttributes){const x=p.morphAttributes[_];for(let h=0,d=x.length;h<d;h++)e.remove(x[h])}p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(e.remove(m),s.delete(p)),n.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(f,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,t.memory.geometries++),p}function l(f){const p=f.attributes;for(const _ in p)e.update(p[_],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const _ in m){const x=m[_];for(let h=0,d=x.length;h<d;h++)e.update(x[h],i.ARRAY_BUFFER)}}function c(f){const p=[],m=f.index,_=f.attributes.position;let x=0;if(m!==null){const A=m.array;x=m.version;for(let E=0,T=A.length;E<T;E+=3){const H=A[E+0],L=A[E+1],b=A[E+2];p.push(H,L,L,b,b,H)}}else if(_!==void 0){const A=_.array;x=_.version;for(let E=0,T=A.length/3-1;E<T;E+=3){const H=E+0,L=E+1,b=E+2;p.push(H,L,L,b,b,H)}}else return;const h=new(xl(p)?wl:bl)(p,1);h.version=x;const d=s.get(f);d&&e.remove(d),s.set(f,h)}function u(f){const p=s.get(f);if(p){const m=f.index;m!==null&&p.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function ef(i,e,t){let n;function r(p){n=p}let s,o;function a(p){s=p.type,o=p.bytesPerElement}function l(p,m){i.drawElements(n,m,s,p*o),t.update(m,n,1)}function c(p,m,_){_!==0&&(i.drawElementsInstanced(n,m,s,p*o,_),t.update(m,n,_))}function u(p,m,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,p,0,_);let h=0;for(let d=0;d<_;d++)h+=m[d];t.update(h,n,1)}function f(p,m,_,x){if(_===0)return;const h=e.get("WEBGL_multi_draw");if(h===null)for(let d=0;d<p.length;d++)c(p[d]/o,m[d],x[d]);else{h.multiDrawElementsInstancedWEBGL(n,m,0,s,p,0,x,0,_);let d=0;for(let A=0;A<_;A++)d+=m[A];for(let A=0;A<x.length;A++)t.update(d,n,x[A])}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function tf(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(s/3);break;case i.LINES:t.lines+=a*(s/2);break;case i.LINE_STRIP:t.lines+=a*(s-1);break;case i.LINE_LOOP:t.lines+=a*s;break;case i.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function nf(i,e,t){const n=new WeakMap,r=new lt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let p=n.get(a);if(p===void 0||p.count!==f){let g=function(){B.dispose(),n.delete(a),a.removeEventListener("dispose",g)};var m=g;p!==void 0&&p.texture.dispose();const _=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,h=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],A=a.morphAttributes.normal||[],E=a.morphAttributes.color||[];let T=0;_===!0&&(T=1),x===!0&&(T=2),h===!0&&(T=3);let H=a.attributes.position.count*T,L=1;H>e.maxTextureSize&&(L=Math.ceil(H/e.maxTextureSize),H=e.maxTextureSize);const b=new Float32Array(H*L*4*f),B=new Ml(b,H,L,f);B.type=tn,B.needsUpdate=!0;const ie=T*4;for(let M=0;M<f;M++){const W=d[M],k=A[M],K=E[M],Q=H*L*4*M;for(let X=0;X<W.count;X++){const J=X*ie;_===!0&&(r.fromBufferAttribute(W,X),b[Q+J+0]=r.x,b[Q+J+1]=r.y,b[Q+J+2]=r.z,b[Q+J+3]=0),x===!0&&(r.fromBufferAttribute(k,X),b[Q+J+4]=r.x,b[Q+J+5]=r.y,b[Q+J+6]=r.z,b[Q+J+7]=0),h===!0&&(r.fromBufferAttribute(K,X),b[Q+J+8]=r.x,b[Q+J+9]=r.y,b[Q+J+10]=r.z,b[Q+J+11]=K.itemSize===4?r.w:1)}}p={count:f,texture:B,size:new De(H,L)},n.set(a,p),a.addEventListener("dispose",g)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let _=0;for(let h=0;h<c.length;h++)_+=c[h];const x=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(i,"morphTargetBaseInfluence",x),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",p.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",p.size)}return{update:s}}function rf(i,e,t,n){let r=new WeakMap;function s(l){const c=n.render.frame,u=l.geometry,f=e.get(l,u);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class Ll extends Tt{constructor(e,t,n,r,s,o,a,l,c,u=Mi){if(u!==Mi&&u!==wi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Mi&&(n=jn),n===void 0&&u===wi&&(n=bi),super(null,r,s,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:wt,this.minFilter=l!==void 0?l:wt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Dl=new Tt,Ao=new Ll(1,1),Ul=new Ml,Il=new Wc,Nl=new Cl,bo=[],wo=[],Ro=new Float32Array(16),Co=new Float32Array(9),Po=new Float32Array(4);function Li(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=bo[r];if(s===void 0&&(s=new Float32Array(r),bo[r]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(s,a)}return s}function pt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function mt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Kr(i,e){let t=wo[e];t===void 0&&(t=new Int32Array(e),wo[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function sf(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function af(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2fv(this.addr,e),mt(t,e)}}function of(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(pt(t,e))return;i.uniform3fv(this.addr,e),mt(t,e)}}function lf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4fv(this.addr,e),mt(t,e)}}function cf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;Po.set(n),i.uniformMatrix2fv(this.addr,!1,Po),mt(t,n)}}function uf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;Co.set(n),i.uniformMatrix3fv(this.addr,!1,Co),mt(t,n)}}function hf(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(pt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),mt(t,e)}else{if(pt(t,n))return;Ro.set(n),i.uniformMatrix4fv(this.addr,!1,Ro),mt(t,n)}}function df(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function ff(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2iv(this.addr,e),mt(t,e)}}function pf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pt(t,e))return;i.uniform3iv(this.addr,e),mt(t,e)}}function mf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4iv(this.addr,e),mt(t,e)}}function _f(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function gf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pt(t,e))return;i.uniform2uiv(this.addr,e),mt(t,e)}}function vf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pt(t,e))return;i.uniform3uiv(this.addr,e),mt(t,e)}}function xf(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pt(t,e))return;i.uniform4uiv(this.addr,e),mt(t,e)}}function Sf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Ao.compareFunction=vl,s=Ao):s=Dl,t.setTexture2D(e||s,r)}function Mf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Il,r)}function Ef(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Nl,r)}function yf(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Ul,r)}function Tf(i){switch(i){case 5126:return sf;case 35664:return af;case 35665:return of;case 35666:return lf;case 35674:return cf;case 35675:return uf;case 35676:return hf;case 5124:case 35670:return df;case 35667:case 35671:return ff;case 35668:case 35672:return pf;case 35669:case 35673:return mf;case 5125:return _f;case 36294:return gf;case 36295:return vf;case 36296:return xf;case 35678:case 36198:case 36298:case 36306:case 35682:return Sf;case 35679:case 36299:case 36307:return Mf;case 35680:case 36300:case 36308:case 36293:return Ef;case 36289:case 36303:case 36311:case 36292:return yf}}function Af(i,e){i.uniform1fv(this.addr,e)}function bf(i,e){const t=Li(e,this.size,2);i.uniform2fv(this.addr,t)}function wf(i,e){const t=Li(e,this.size,3);i.uniform3fv(this.addr,t)}function Rf(i,e){const t=Li(e,this.size,4);i.uniform4fv(this.addr,t)}function Cf(i,e){const t=Li(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Pf(i,e){const t=Li(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Lf(i,e){const t=Li(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Df(i,e){i.uniform1iv(this.addr,e)}function Uf(i,e){i.uniform2iv(this.addr,e)}function If(i,e){i.uniform3iv(this.addr,e)}function Nf(i,e){i.uniform4iv(this.addr,e)}function Ff(i,e){i.uniform1uiv(this.addr,e)}function Of(i,e){i.uniform2uiv(this.addr,e)}function Bf(i,e){i.uniform3uiv(this.addr,e)}function zf(i,e){i.uniform4uiv(this.addr,e)}function Hf(i,e,t){const n=this.cache,r=e.length,s=Kr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Dl,s[o])}function kf(i,e,t){const n=this.cache,r=e.length,s=Kr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Il,s[o])}function Gf(i,e,t){const n=this.cache,r=e.length,s=Kr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Nl,s[o])}function Vf(i,e,t){const n=this.cache,r=e.length,s=Kr(t,r);pt(n,s)||(i.uniform1iv(this.addr,s),mt(n,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Ul,s[o])}function Wf(i){switch(i){case 5126:return Af;case 35664:return bf;case 35665:return wf;case 35666:return Rf;case 35674:return Cf;case 35675:return Pf;case 35676:return Lf;case 5124:case 35670:return Df;case 35667:case 35671:return Uf;case 35668:case 35672:return If;case 35669:case 35673:return Nf;case 5125:return Ff;case 36294:return Of;case 36295:return Bf;case 36296:return zf;case 35678:case 36198:case 36298:case 36306:case 35682:return Hf;case 35679:case 36299:case 36307:return kf;case 35680:case 36300:case 36308:case 36293:return Gf;case 36289:case 36303:case 36311:case 36292:return Vf}}class Xf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Tf(t.type)}}class Yf{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Wf(t.type)}}class qf{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],n)}}}const Cs=/(\w+)(\])?(\[|\.)?/g;function Lo(i,e){i.seq.push(e),i.map[e.id]=e}function Zf(i,e,t){const n=i.name,r=n.length;for(Cs.lastIndex=0;;){const s=Cs.exec(n),o=Cs.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){Lo(t,c===void 0?new Xf(a,i,e):new Yf(a,i,e));break}else{let f=t.map[a];f===void 0&&(f=new qf(a),Lo(t,f)),t=f}}}class Fr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Zf(s,o,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&n.push(o)}return n}}function Do(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Kf=37297;let jf=0;function $f(i,e){const t=i.split(`
...
`)}function rp(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ki(i){return i!==""}function Io(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function No(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const sp=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ea(i){return i.replace(sp,op)}const ap=new Map;function op(i,e){let t=Fe[e];if(t===void 0){const n=ap.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ea(t)}const lp=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Fo(i){return i.replace(lp,cp)}function cp(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Oo(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function up(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ta?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Yl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===fn&&(e="SHADOWMAP_TYPE_VSM"),e}function hp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ti:case Ai:e="ENVMAP_TYPE_CUBE";break;case Yr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function dp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ai:e="ENVMAP_MODE_REFRACTION";break}return e}function fp(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case ol:e="ENVMAP_BLENDING_MULTIPLY";break;case hc:e="ENVMAP_BLENDING_MIX";break;case dc:e="ENVMAP_BLENDING_ADD";break}return e}function pp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function mp(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=up(t),c=hp(t),u=dp(t),f=fp(t),p=pp(t),m=np(t),_=ip(s),x=r.createProgram();let h,d,A=t.glslVersion?"#version "+t.glslVersion+`
...
}`;class gm{constructor(){I(this,"sharedUniforms",{u_blueNoiseTexture:{value:null},u_blueNoiseTexelSize:{value:null},u_blueNoiseCoordOffset:{value:new De}});I(this,"TEXTURE_SIZE",128)}preInit(){Sn.loadTexture(ot.ASSETS_PATH+"textures/LDR_RGB1_0.png",e=>{e.generateMipmaps=!1,e.minFilter=e.magFilter=wt,e.wrapS=e.wrapT=Or,e.needsUpdate=!0,this.sharedUniforms.u_blueNoiseTexture.value=e,this.sharedUniforms.u_blueNoiseTexelSize.value=new De(1/this.TEXTURE_SIZE,1/this.TEXTURE_SIZE)}),Fe.getBlueNoise=_m}update(e){this.sharedUniforms.u_blueNoiseCoordOffset.value.set(Math.random(),Math.random())}}const Pi=new gm;class vm{constructor(){I(this,"PI",Math.PI)}clamp(e,t,n){return e<t?t:e>n?n:e}mix(e,t,n){return e+(t-e)*n}cUnMix(e,t,n){return this.clamp((n-e)/(t-e),0,1)}saturate(e){return this.clamp(e,0,1)}fit(e,t,n,r,s,o){return e=this.cUnMix(t,n,e),o&&(e=o(e)),r+e*(s-r)}}const Ie=new vm;class xm{quartInOut(e){return(e*=2)<1?.5*e*e*e*e:-.5*((e-=2)*e*e*e-2)}sineOut(e){return Math.sin(e*Math.PI/2)}backIn(e){let t=1.70158;return e*e*((t+1)*e-t)}backOut(e,t=1.70158){return--e*e*((t+1)*e+t)+1}backInOut(e){let t=2.5949095;return(e*=2)<1?.5*e*e*((t+1)*e-t):.5*((e-=2)*e*((t+1)*e+t)+2)}}function Sm(i,e,t,n,r){if(i===0)return 0;if(i===1)return 1;function s(l,c,u,f,p){const m=3*(u-c),_=3*(f-u)-m;return(((p-c-m-_)*l+_)*l+m)*l+c}function o(l,c,u,f=1e-6){let p=0,m=1,_=l;for(;p<m;){const x=s(_,0,c,u,1);if(Math.abs(x-l)<f)return _;x<l?p=_:m=_,_=(p+m)/2}return _}const a=o(i,e,n);return s(a,0,t,r,1)}function vi(i){return Sm(i,.3,0,0,1)}const Er=new xm,et={NOT_STARTED:"not-started",STARTED:"started",FREE:"free",RESULT:"result",RESULT_ANIMATION:"result_animation",RESTART_ANIMATION:"restart_animation",RESTART:"restart"},yr=Object.values(et),it={NONE:"none",PAUSE:"pause",STOP:"stop",COMPLETED:"completed",FAILED:"failed"},Zn={LEVEL_1:1,LEVEL_2:2,LEVEL_3:3};class Mm{constructor(){I(this,"statusIndex",0);I(this,"status",yr[this.statusIndex]);I(this,"result",it.NONE);I(this,"stateSignal",new xn);I(this,"spawnSignal",new xn);I(this,"endCycleSignal",new xn);I(this,"gameEndedSignal",new xn);I(this,"statusUpdateQueue",[]);I(this,"completeAnimationLevel",Zn.LEVEL_1)}init(){this.updateFlags(),ot.AUTO_START&&this.setStart()}updateAfterCycle(){if(z.errorBlock&&z.errorBlock.isErrorBlockFalling)return;this.isStart?this.setFree():this.isResult&&this.setResultAnimation();const e=this.statusUpdateQueue.shift();e==null||e()}updateFlags(){this.hasNotStarted=this.status===et.NOT_STARTED,this.isStart=this.status===et.STARTED,this.isFree=this.status===et.FREE,this.isResult=this.status===et.RESULT,this.isResultAnimation=this.status===et.RESULT_ANIMATION,this.isRestartAnimation=this.status===et.RESTART_ANIMATION,this.isRestart=this.status===et.RESTART,this.isSuccessResult=(this.isResult||this.isResultAnimation)&&this.result===it.COMPLETED,this.isFailResult=(this.isResult||this.isResultAnimation)&&this.result===it.FAILED,this.isPaused=(this.isResult||this.isResultAnimation)&&this.result===it.PAUSE,this.isStopped=(this.isResult||this.isResultAnimation)&&this.result===it.STOP}_updateStatus(e,t=!1){if(!z.showVisual)return!1;const n=yr.indexOf(e);return(this.statusIndex+1)%yr.length===n?(this.statusIndex=n,this.status=yr[this.statusIndex],t||(this.updateFlags(),this.stateSignal.dispatch(this.status,this.result)),!0):!1}_updateStatusAndResult(e,t,n=null){this._updateStatus(e,!0)&&(z.errorBlock&&!z.errorBlock.isErrorBlockFalling&&(z.errorBlock.preventErrorBlockFallAnimation(),z.errorBlock=null),this.result=t,this.completeAnimationLevel=n,this.updateFlags(),this.stateSignal.dispatch(this.status,this.result,this.completeAnimationLevel))}set(e){var n;(n={start:this.setStart,free:this.setFree,pause:this.setPause,resume:this.setResume,stop:this.setStop,success:this.setComplete,success2:this.setComplete2,success3:this.setComplete3,fail:this.setFail,resultAnimation:this.setResultAnimation,restartAnimation:this.setRestartAnimation,restart:this.setRestart,showVisual:this.showVisual}[e])==null||n.call(this)}showVisual(){z.showVisual=!0}_queueStatusUpdate(e,t=null,n=null){this.statusUpdateQueue.push(()=>t?this._updateStatusAndResult(e,t,n):this._updateStatus(e))}reset(){this._queueStatusUpdate(et.NOT_STARTED,it.NONE)}setStart(){this._queueStatusUpdate(et.STARTED)}setFree(){this._queueStatusUpdate(et.FREE)}setPause(){z.isPaused=!0}setResume(){z.isPaused=!1}setStop(){this._queueStatusUpdate(et.RESULT,it.STOP)}setComplete(){this._queueStatusUpdate(et.RESULT,it.COMPLETED,Zn.LEVEL_1)}setComplete2(){this._queueStatusUpdate(et.RESULT,it.COMPLETED,Zn.LEVEL_2)}setComplete3(){this._queueStatusUpdate(et.RESULT,it.COMPLETED,Zn.LEVEL_3)}setFail(){this._queueStatusUpdate(et.RESULT,it.FAILED)}setResultAnimation(){this._queueStatusUpdate(et.RESULT_ANIMATION)}setRestartAnimation(){this._queueStatusUpdate(et.RESTART_ANIMATION)}setRestart(){this.statusUpdateQueue.push(()=>{this._updateStatus(et.RESTART)&&this.gameEndedSignal.dispatch()})}}const Le=new Mm;class el{constructor(e){I(this,"id",-1);I(this,"isMoving",!1);I(this,"hasBeenSpawned",!1);I(this,"hasAnimationEnded",!1);I(this,"hasBeenEvaluated",!1);I(this,"currentTile",null);I(this,"targetTile",null);I(this,"moveAnimationRatio",0);I(this,"spawnAnimationRatio",0);I(this,"spawnAnimationRatioUnclamped",-Math.random());I(this,"easedAnimationRatio",0);I(this,"randomVector",{x:Math.random()-.5,y:Math.random()-.5});I(this,"lifeCycle",0);I(this,"easingFunction",null);I(this,"errorLifeCycle",0);I(this,"isErrorBlock",!1);I(this,"errorPreFallAnimationTime",0);I(this,"errorPreFallAnimationTimeScale",0);I(this,"errorFallAnimationTime",0);I(this,"isErrorBlockFalling",!1);I(this,"skipFallAnimation",!1);this.id=e,this.init()}init(){this._setNewEasingFunction()}_setNewEasingFunction(){const e=Math.random(),t=.25;this.easingFunction=n=>vi(Ie.fit(n,e*t,e*t+(1-t),0,1))}updateTile(){this.currentTile&&(this.currentTile.isOccupied=!0,this.currentTile.willBeOccupied=!1)}_findBestTile(e,t){return e.find(n=>n.isOccupied||n.willBeOccupied||n.isMain?!1:t||this.currentTile.priority>=n.priority)}moveToNextTile(e=!1,t=0){if(this.hasBeenEvaluated=!0,this.moveAnimationRatio=-t*(this.isErrorBlock?0:1),!this.currentTile)return;if(this.isErrorBlock){this.isMoving=!0,this.targetTile=this.currentTile;return}this.currentTile.shuffleReachableNeighbours();const n=e?this.currentTile.reachableNeighbours:this.currentTile.prioritySortedReachableNeighbours,r=this._findBestTile(n,e);r&&(!this.currentTile.isMain||Math.random()<=.8)?(this.targetTile=r,this.targetTile.willBeOccupied=!0,this.isMoving=!0):this.hasAnimationEnded=!0}resetAfterCycle(){var e;this.hasBeenEvaluated=!1,this.hasAnimationEnded=!1,this.moveAnimationRatio=0,this.easedAnimationRatio=0,this.isMoving=!1,this.lifeCycle++,this.isErrorBlock&&!this.skipFallAnimation&&(this.errorLifeCycle++,this.isErrorBlockFalling=this.errorLifeCycle>=z.errorBlockMaxLifeCycle-1),(e=this.currentTile)!=null&&e.isBorder&&!z.errorBlock&&Math.random()<.5&&z.activeBlocksCount>=z.minSpawnedBlocksForTheErrorBlock&&Le.isFree&&(z.errorBlock=this,this.isErrorBlock=!0),this._setNewEasingFunction(),this.updateTile()}reset(e=!1){var t;this.isErrorBlock&&(this.errorLifeCycle=0,this.isErrorBlock=!1,this.currentTile.reset(),(t=this.targetTile)==null||t.reset(),this.errorFallAnimationTime=0,this.isErrorBlockFalling=!1,this.errorPreFallAnimationTime=0,this.errorPreFallAnimationTimeScale=0,this.errorFallAnimationTime=0,this.skipFallAnimation=!1),this.id=e?this.id:-1,this.isMoving=!1,this.hasBeenSpawned=!1,this.hasAnimationEnded=!1,this.hasBeenEvaluated=!1,this.currentTile=null,this.targetTile=null,this.moveAnimationRatio=0,this.spawnAnimationRatio=0,this.spawnAnimationRatioUnclamped=-Math.random(),this.easedAnimationRatio=0,this.lifeCycle=0}preventErrorBlockFallAnimation(){this.skipFallAnimation=!0}_onMovementEnd(){this.moveAnimationRatio=1,this.currentTile&&(this.currentTile.isOccupied=!1),this.currentTile=this.targetTile,this.targetTile=null,this.hasAnimationEnded=!0,this.updateTile()}_updateSpawnAnimation(e){this.spawnAnimationRatioUnclamped+=.75*z.animationSpeed*e,this.spawnAnimationRatio=Math.max(0,Math.min(1,this.spawnAnimationRatioUnclamped)),this.spawnAnimationRatio===1&&(this.hasBeenSpawned=!0)}_updateMovement(e){(this.isMoving&&!this.hasAnimationEnded||Le.isResultAnimation)&&(this.moveAnimationRatio=Math.min(1,this.moveAnimationRatio+z.animationSpeed*e*(this.isErrorBlock?.7:1)),this.easedAnimationRatio=this.easingFunction(Math.max(0,this.moveAnimationRatio)),this.easedAnimationRatio===1&&(Le.isFree||Le.isResult)&&this._onMovementEnd())}_updateTileRatios(){const e=Math.max(0,Math.min(1,this.hasBeenSpawned?this.easedAnimationRatio:this.spawnAnimationRatio));this.currentTile&&(this.currentTile.activeRatio=this.hasBeenSpawned?this.targetTile?1-e:1:this.spawnAnimationRatio),this.targetTile&&(this.targetTile.activeRatio=e),this.isErrorBlock&&this.isErrorBlockFalling&&(this.currentTile.activeRatio=0,this.targetTile&&(this.targetTile.activeRatio=0))}update(e){this.hasBeenSpawned?this._updateMovement(e):this._updateSpawnAnimation(e),this.isErrorBlockFalling&&(this.errorFallAnimationTime=this.errorFallAnimationTime+3*z.animationSpeed*e),this.isErrorBlock&&(this.errorPreFallAnimationTimeScale=this.errorPreFallAnimationTimeScale+3*e,this.errorPreFallAnimationTimeScale=Math.min(20,this.errorPreFallAnimationTimeScale),this.errorPreFallAnimationTime=this.errorPreFallAnimationTime+this.errorPreFallAnimationTimeScale*e,this.skipFallAnimation&&(this.errorPreFallAnimationTime=0,this.errorPreFallAnimationTimeScale=0)),this._updateTileRatios()}}class Em{constructor(){I(this,"currentAnimationStyle",null);I(this,"ratio",0);I(this,"duration",8);I(this,"towerRotationRatio",0);I(this,"floatingCoinsRatio",0);I(this,"floatingCubesRatio",0);I(this,"vortexCoinsRatio",0);I(this,"pushDownRatio",0);I(this,"successColorTowerRatio",0);I(this,"floatingCubesDisplacement",1);I(this,"completeAnimationEndedSignal",new xn)}init(){Le.stateSignal.add((e,t,n)=>{e===et.RESULT&&t===it.COMPLETED&&this.triggerNewAnimation(n)})}triggerNewAnimation(e){this.currentAnimationStyle=e}resetRatios(){this.ratio=0,this.towerRotationRatio=0,this.floatingCoinsRatio=0,this.floatingCubesRatio=0,this.vortexCoinsRatio=0,this.pushDownRatio=0,this.successColorTowerRatio=0,this.floatingCubesDisplacement=1,this.currentAnimationStyle=null}updateRatios1(){this.floatingCubesDisplacement=1,this.towerRotationRatio=0,this.floatingCoinsRatio=0,this.floatingCubesRatio=Ie.fit(this.ratio,.2,.49,0,1.2),this.pushDownRatio=Ie.fit(this.ratio,.45,.55,0,1),this.successColorTowerRatio=Ie.fit(this.ratio,.45,.7,0,1),this.vortexCoinsRatio=Ie.fit(this.ratio,.55,1,0,1)}updateRatios2(){this.floatingCubesDisplacement=1.5,this.floatingCoinsRatio=0,this.towerRotationRatio=Ie.fit(this.ratio,.1,.45,0,1),this.floatingCubesRatio=Ie.fit(this.ratio,.15,.49,0,1.2),this.pushDownRatio=Ie.fit(this.ratio,.45,.55,0,1),this.successColorTowerRatio=Ie.fit(this.ratio,.45,.7,0,1),this.vortexCoinsRatio=Ie.fit(this.ratio,.55,1,0,1)}updateRatios3(){this.floatingCubesDisplacement=2,this.towerRotationRatio=Ie.fit(this.ratio,.1,.5,0,1),this.floatingCoinsRatio=Ie.fit(this.ratio,.2,.51,0,1),this.floatingCubesRatio=Ie.fit(this.ratio,.2,.49,0,1.2),this.pushDownRatio=Ie.fit(this.ratio,.45,.55,0,1),this.successColorTowerRatio=Ie.fit(this.ratio,.45,.7,0,1),this.vortexCoinsRatio=Ie.fit(this.ratio,.6,1,0,1)}update(e){switch(this.ratio+=(this.currentAnimationStyle?1:0)*e/this.duration,this.ratio=Ie.clamp(this.ratio,0,1),this.currentAnimationStyle){case Zn.LEVEL_1:this.updateRatios1();break;case Zn.LEVEL_2:this.updateRatios2();break;case Zn.LEVEL_3:this.updateRatios3();break}this.ratio===1&&(this.completeAnimationEndedSignal.dispatch(),this.resetRatios())}}const Dt=new Em;class ym{constructor(){I(this,"isActive",!1);I(this,"ratio",0);I(this,"duration",4);I(this,"spawnRatio",0);I(this,"pushDownRatio",0);I(this,"stopAnimationEndedSignal",new xn)}init(){Le.stateSignal.add((e,t,n)=>{e===et.RESULT&&t===it.STOP&&(this.isActive=!0)})}resetRatios(){this.ratio=0,this.pushDownRatio=0,this.spawnRatio=0,this.isActive=!1}update(e){this.ratio+=(this.isActive?1:0)*e/this.duration,this.ratio=Ie.clamp(this.ratio,0,1),this.spawnRatio=Ie.fit(this.ratio,0,.25,0,2.5),this.pushDownRatio=Ie.fit(this.ratio,.45,.55,0,1),this.ratio===1&&(this.stopAnimationEndedSignal.dispatch(),this.resetRatios())}}const mn=new ym;class Tm{constructor(){I(this,"isActive",!1);I(this,"ratio",0);I(this,"duration",4);I(this,"shakeRatio",0);I(this,"floatingCubesRatio",0);I(this,"spawnRatio",0);I(this,"pushDownRatio",0);I(this,"errorAnimationEndedSignal",new xn)}init(){Le.stateSignal.add((e,t,n)=>{e===et.RESULT&&t===it.FAILED&&(this.isActive=!0)})}resetRatios(){this.ratio=0,this.shakeRatio=0,this.floatingCubesRatio=0,this.pushDownRatio=0,this.spawnRatio=0,this.isActive=!1}update(e){this.ratio+=(this.isActive?1:0)*e/this.duration,this.ratio=Ie.clamp(this.ratio,0,1),this.shakeRatio=Ie.fit(this.ratio,0,.3,0,1),this.floatingCubesRatio=Ie.fit(this.ratio,.35,.65,0,1),this.spawnRatio=Ie.fit(this.ratio,.3,.55,0,2.5),this.pushDownRatio=Ie.fit(this.ratio,.6,.8,0,1),this.ratio===1&&(this.errorAnimationEndedSignal.dispatch(),this.resetRatios())}}const St=new Tm;class Am{constructor(){I(this,"blocks",[]);I(this,"lastSpawnedBlock",null);I(this,"cycleIndex",0);I(this,"animationSpeedRatio",0);I(this,"firstStartAnimationRatio",0);I(this,"previousSuccessBlocksAnimationRatio",0);I(this,"isEndAnimationActive",!1);I(this,"wasSuccess",!1)}init(){Le.init(),Dt.init(),mn.init(),St.init(),Jt.init(),Dt.completeAnimationEndedSignal.add(()=>{Le.setRestart(),this._startNewCycle()}),mn.stopAnimationEndedSignal.add(()=>{Le.setRestart(),this._startNewCycle()}),St.errorAnimationEndedSignal.add(()=>{Le.setRestart(),this._startNewCycle()})}_spawnBlock(){this._shouldPreventSpawn()||(Le.isSuccessResult?this._spawnMultipleBlocks():this._spawnSingleBlock(),!(this.blocks.length===z.maxFreeBlocksCount&&Le.isFree)&&Le.spawnSignal.dispatch())}_shouldPreventSpawn(){return Le.isFailResult||Le.isStopped||this.blocks.length>=Xt||Jt.mainTile.isOccupied&&!Le.isSuccessResult}_spawnMultipleBlocks(){const e=Xt-z.activeBlocksCount;for(let t=0;t<e;t++){const n=Jt.getRandomFreeTile();if(n){const r=new el(this.blocks.length);r.currentTile=n,r.init(),r.updateTile(),this.blocks=[r,...this.blocks]}}}_spawnSingleBlock(){let e=null;z.errorBlock&&z.errorBlock.errorLifeCycle>=z.errorBlockMaxLifeCycle?(z.errorBlock.reset(!0),Kn.resetBlockFromLogicBlock(z.errorBlock),e=z.errorBlock,z.errorBlock=null):this.blocks.length<z.maxFreeBlocksCount&&Le.isFree&&(e=new el(this.blocks.length),this.lastSpawnedBlock=e),e&&(e.currentTile=Jt.mainTile,e.init(),e.updateTile())}_startNewCycle(){Le.updateAfterCycle(),![et.NOT_STARTED,et.RESTART_ANIMATION,et.RESTART,et.STARTED].includes(Le.status)&&(this.lastSpawnedBlock&&(this.blocks=[this.lastSpawnedBlock,...this.blocks],this.lastSpawnedBlock=null),z.activeBlocksCount=this.blocks.length,!(Le.isFailResult||Le.isStopped)&&(this.blocks.forEach(e=>e.resetAfterCycle()),Le.endCycleSignal.dispatch(),this.cycleIndex++,this._spawnBlock(),this._calculatePaths()))}_calculatePaths(){var t;(t=this.lastSpawnedBlock)!=null&&t.hasBeenSpawned&&this.lastSpawnedBlock.moveToNextTile(Le.isFree,0);const e=this.cycleIndex%4===0?!0:z.activeBlocksCount<z.maxFreeBlocksCount-1;this.blocks.forEach((n,r)=>{!n.hasBeenEvaluated&&n.hasBeenSpawned&&n.moveToNextTile(e,r*.2)})}reset(){this.blocks.forEach(t=>t.reset()),Kn.reset(),Jt.reset(),this.blocks=[],this.lastSpawnedBlock=null,this.cycleIndex=0,this.animationSpeedRatio=0,this.previousSuccessBlocksAnimationRatio=this.wasSuccess?1:0,this.isEndAnimationActive=!1;const e=ot.AUTO_RESTART&&[it.FAILED,it.COMPLETED].includes(Le.result);Le.reset(),this._startNewCycle(),e&&(Le.setStart(),Le.updateFlags())}_updateAnimationRatios(e){const{isResult:t}=Le;this.firstStartAnimationRatio=Ie.saturate(this.firstStartAnimationRatio+e*(z.showVisual?1:0)),this.animationSpeedRatio=Math.min(1,this.animationSpeedRatio+e*(t?1:0)),this.previousSuccessBlocksAnimationRatio=Ie.saturate(this.previousSuccessBlocksAnimationRatio-.25*e)}_checkCycleCompletion(){let e=!0;return this.lastSpawnedBlock&&(e=e&&this.lastSpawnedBlock.hasBeenSpawned),this.blocks.forEach(t=>{t.lifeCycle>0?e=e&&t.hasBeenEvaluated&&t.hasAnimationEnded:e=e&&t.spawnAnimationRatio===1}),e||Le.isResultAnimation||Le.isFailResult||Le.isStopped}update(e){if(this._updateAnimationRatios(e),Dt.update(e),mn.update(e),St.update(e),Le.hasNotStarted){this._startNewCycle();return}if(Le.isRestart){this.wasSuccess=Le.result===it.COMPLETED,this.reset();return}Le.isResultAnimation&&Le.setRestartAnimation(),Jt.preUpdate(e),this.lastSpawnedBlock&&this.lastSpawnedBlock.update(e),this.blocks.forEach(n=>n.update(e)),Jt.update(e),this._checkCycleCompletion()&&this._startNewCycle()}}const Lt=new Am,bm=Math.PI/2,_i=new U;class wm{constructor(){this.animation=0,this.boardDir=new De,this.boardPos=new De,this.pos=new U,this.orient=new qt,this.showRatio=0,this.spinPivot=new U,this.spinOrient=new qt,this.spinOrient2=new qt}reset(){this.animation=0,this.boardDir.set(0,0),this.boardPos.set(0,0),this.pos.set(0,0,0),this.orient.identity(),this.showRatio=0,this.spinPivot.set(0,0,0),this.spinOrient.identity()}update(e){this.pos.set(this.boardPos.x,0,-this.boardPos.y),this.spinPivot.set(this.boardDir.x*.5,-.5,-this.boardDir.y*.5),_i.set(-this.boardDir.y,0,-this.boardDir.x),this.spinOrient.setFromAxisAngle(_i,this.animation*bm)}addsFallAnimation(e){_i.set(this.boardDir.x,-e,-this.boardDir.y),this.pos.addScaledVector(_i,e),_i.set(this.boardDir.x*.5,0,-this.boardDir.y*.5),this.spinPivot.lerp(_i,Ie.saturate(e))}}var Tr=`#ifndef IS_BASE
...
}`,tl=`uniform vec3 u_lightPosition;
uniform sampler2D u_infoTexture;
uniform sampler2D u_infoTextureLinear;
...
void main() {
	...
	float fragCoordZ = 0.5 * vHighPrecisionZW[0] / vHighPrecisionZW[1] + 0.5;
    gl_FragColor = packDepthToRGBA( fragCoordZ );
}`;const Hi=2*Xt,gt=new De,Ar=new De,gi=new U,il=new U,Is=new qt,rl=new qt,sl=new we,br=new we,Ns=new we,wr=new we,Pn=new we,Rr=new we;class Rm{constructor(){I(this,"container",new ft);I(this,"_baseMesh");I(this,"_blocksMesh");I(this,"_blockList",[]);I(this,"_blockRenderList",[]);I(this,"_blockUpdateRange",{start:0,count:0});I(this,"sharedUniforms",{u_lightPosition:{value:new U(-2,6,-4)},u_goboTexture:{value:null},u_goboIntensity:{value:0},u_infoTexture:{value:null},u_infoTextureLinear:{value:null},u_restartAnimationRatio:{value:0},u_endAnimationRatio:{value:0}});I(this,"successColorRatio",0);I(this,"infoTexture",null)}preload(){this._blockList=Array(Hi).fill().map(()=>new wm),this._blockRenderList=[...this._blockList],Sn.loadBuf(ot.ASSETS_PATH+"models/BASE.buf",e=>{this._onBaseBlocksLoaded(e)}),Sn.loadBuf(ot.ASSETS_PATH+"models/BOX.buf",e=>{this._onBoxLoaded(e)}),Sn.loadBuf(ot.ASSETS_PATH+"models/lose_animation.buf",e=>{const{position:t,orient:n}=e.attributes;this.animationTotalFrames=t.count/Xt,this.loseAnimationPositionArray=t.array,this.loseAnimationOrientArray=n.array}),Sn.loadTexture(ot.ASSETS_PATH+"textures/gobo.jpg",e=>{e.flipY=!1,e.needsUpdate=!0,this.sharedUniforms.u_goboTexture.value=e})}_onBaseBlocksLoaded(e){const t=new yt({uniforms:{...Gr.merge([ae.lights]),...z.sharedUniforms,...this.sharedUniforms,...Pi.sharedUniforms,u_color:{value:new we(this.neutralColor)},u_blocksColor:{value:new we},u_yDisplacement:{value:0},u_prevSuccessColor:{value:new we(z.successColor).convertSRGBToLinear()},u_successColor:{value:new we(z.successColor).convertSRGBToLinear()},u_successAnimationRatio:{value:0}},vertexShader:Tr,fragmentShader:tl,lights:!0,transparent:!0});this._baseMesh=new Nt(e,t),this._baseMesh.receiveShadow=this._baseMesh.castShadow=!0,this._baseMesh.frustumCulled=!1,this._baseMesh.material.defines.IS_BASE=!0,this._baseMesh.customDepthMaterial=new yt({vertexShader:Tr,fragmentShader:nl,defines:{IS_DEPTH:!0,IS_BASE:!0}}),this.container.add(this._baseMesh)}_onBoxLoaded(e){const t=new Ba;t.index=e.index,Object.keys(e.attributes).forEach(s=>{t.setAttribute(s,e.attributes[s])}),t.instanceCount=Hi;const n=(s,o)=>{const a=new Float32Array(Hi*o);return t.setAttribute(s,new Vr(a,o).setUsage(Uc)),a};this._instancePosArray=n("instancePos",3),this._instanceOrientArray=n("instanceOrient",4),this._instanceShowRatioArray=n("instanceShowRatio",1),this._instanceSpinPivotArray=n("instanceSpinPivot",3),this._instanceSpinOrientArray=n("instanceSpinOrient",4),this._instanceColorArray=n("instanceColor",3),this._instanceIsActiveArray=n("instanceIsActive",1),this._instanceNextDirectionArray=n("instanceNextDirection",2);const r=new yt({uniforms:{...Gr.merge([ae.lights]),...z.sharedUniforms,...this.sharedUniforms,...Pi.sharedUniforms},vertexShader:Tr,fragmentShader:tl,lights:!0});this._blocksMesh=new Nt(t,r),this._blocksMesh.frustumCulled=!1,this._blocksMesh.castShadow=this._blocksMesh.receiveShadow=!0,this._blocksMesh.customDepthMaterial=new yt({uniforms:{...this.sharedUniforms},vertexShader:Tr,fragmentShader:nl,defines:{IS_DEPTH:!0}}),this.container.add(this._blocksMesh)}_onLoseAnimationLoaded(e){const{position:t,orient:n}=e.attributes;this.animationTotalFrames=t.count/Xt,this.loseAnimationPositionArray=t.array,this.loseAnimationOrientArray=n.array}init(){this.directLight=new sm(16777215,1),this.directLight.castShadow=!0,this.directLight.shadow.camera.near=z.lightCameraNear,this.directLight.shadow.camera.far=z.lightCameraFar,this.directLight.shadow.camera.right=z.lightCameraSize,this.directLight.shadow.camera.left=-z.lightCameraSize,this.directLight.shadow.camera.top=z.lightCameraSize,this.directLight.shadow.camera.bottom=-z.lightCameraSize,this.directLight.shadow.bias=z.lightCameraBias,this.directLight.shadow.mapSize.width=768,this.directLight.shadow.mapSize.height=768,z.scene.add(this.directLight),z.scene.add(this.directLight.target),this.isShadowCameraHelperVisible=!1,this.shadowCameraHelper=new am(this.directLight.shadow.camera,1,"#ff0000"),z.lightCameraUpdateSignal.add(()=>{this.directLight.shadow.camera.updateProjectionMatrix(),this.shadowCameraHelper.update()}),z.lightCameraHelperSignal.add(()=>{this.isShadowCameraHelperVisible=!this.isShadowCameraHelperVisible,this.isShadowCameraHelperVisible?z.scene.add(this.shadowCameraHelper):z.scene.remove(this.shadowCameraHelper)}),this._assignFinalAnimationToTiles();let e=new Float32Array(hm*4);for(let t=0,n=0;t<pn;t++)for(let r=0;r<pn;r++,n+=4)e[n+0]=0,e[n+1]=0,e[n+2]=1,e[n+3]=1;this.infoTexture=new Go(e,pn,pn,kt,tn),this.infoTextureLinear=new Go(e,pn,pn,kt,tn,Aa,gn,gn,It,It,0),this.infoTextureLinear.needsUpdate=!0,this.sharedUniforms.u_infoTexture.value=this.infoTexture,this.sharedUniforms.u_infoTextureLinear.value=this.infoTextureLinear}_assignFinalAnimationToTiles(){Jt.tiles.forEach((e,t)=>{e.forEach((n,r)=>{const s=t*Ut+r;n.loseAnimationPositionArray=new Float32Array(this.animationTotalFrames*3),n.loseAnimationOrientArray=new Float32Array(this.animationTotalFrames*4);for(let o=0;o<this.animationTotalFrames;o++){const a=(o*Xt+s)*3,l=(o*Xt+s)*4;n.loseAnimationPositionArray.set(this.loseAnimationPositionArray.subarray(a,a+3),o*3),n.loseAnimationOrientArray.set(this.loseAnimationOrientArray.subarray(l,l+4),o*4)}})})}reset(){this.successColorRatio=0,this._blockList.forEach(e=>e.reset())}resetBlockFromLogicBlock(e){this._blockList[e.id].reset()}_updateColors(e){sl.set(z.mainColor),br.set(z.successColor),Ns.set(z.failColor),wr.set(z.neutralColor),Pn.copy(sl),Le.result===it.FAILED&&St.floatingCubesRatio>0&&Pn.copy(Ns),Le.result===it.COMPLETED&&(this.successColorRatio=Math.min(1,this.successColorRatio+.5*e),Pn.lerp(br,this.successColorRatio)),Le.result!==it.COMPLETED&&Pn.lerp(wr,Ie.saturate(mn.pushDownRatio+St.pushDownRatio)),Pn.convertSRGBToLinear(),wr.convertSRGBToLinear(),br.convertSRGBToLinear();for(let n=0;n<Hi;n++){const r=Lt.blocks.filter(a=>a.id===n)[0],s=n<Lt.blocks.length+(Lt.lastSpawnedBlock?1:0),o=s?Pn:wr;if(s&&(r!=null&&r.isErrorBlock)){let a=Ie.saturate(.5*(1-Math.cos(r.errorPreFallAnimationTime)));r.errorFallAnimationTime>0&&(a=Ie.saturate(.5*(1-Math.cos(14*r.errorFallAnimationTime)))),Rr.lerpColors(o,Ns,a),this._instanceColorArray.set([Rr.r,Rr.g,Rr.b],n*3)}else this._instanceColorArray.set([o.r,o.g,o.b],n*3);this._instanceIsActiveArray[n]=s?1:0}const t=this._baseMesh.material.uniforms;t.u_color.value.set(z.neutralColor).convertSRGBToLinear(),t.u_blocksColor.value.copy(Pn),t.u_successColor.value.copy(br),t.u_prevSuccessColor.value.set(z.neutralColor),t.u_prevSuccessColor.value.lerp(Pn.set(z.successColor),Lt.previousSuccessBlocksAnimationRatio),t.u_prevSuccessColor.value.convertSRGBToLinear()}_updateInfoTexture(){Jt.tiles.forEach(e=>{e.forEach(t=>{let n=t.id%Ut+1,s=((Math.floor(t.id/Ut)+1)*pn+n)*4,o=.5*Dt.floatingCubesRatio*Ie.fit(Dt.pushDownRatio,0,.1,1,0);o+=(St.floatingCubesRatio>0?1:0)*Ie.fit(St.pushDownRatio,0,.1,1,0),o+=mn.spawnRatio*Ie.fit(mn.pushDownRatio,0,.1,1,0),o=Math.min(1,o),this.infoTexture.image.data[s+0]=t.activeRatio*(1-o),this.infoTexture.image.data[s+1]=t.isOccupied||t.willBeOccupied?1:0,this.infoTexture.image.data[s+2]=t.isMain?1:0,this.infoTexture.image.data[s+3]=t.isBorder?1:0})}),this.infoTexture.needsUpdate=!0,this.infoTextureLinear.needsUpdate=!0}_updateFreeBlocks(e){if(Lt.lastSpawnedBlock){const t=this._blockList[Lt.lastSpawnedBlock.id];t.boardPos.set(Lt.lastSpawnedBlock.currentTile.row,Lt.lastSpawnedBlock.currentTile.col),t.showRatio=vi(Ie.saturate(Lt.lastSpawnedBlock.spawnAnimationRatioUnclamped))}Lt.blocks.forEach(t=>{const n=this._blockList[t.id];n&&(n.showRatio=vi(Ie.saturate(t.spawnAnimationRatioUnclamped)),n.boardPos.set(t.currentTile.row,t.currentTile.col),t.targetTile&&n.boardDir.set(t.targetTile.row-t.currentTile.row,t.targetTile.col-t.currentTile.col),n.animation=t.hasAnimationEnded?0:t.easedAnimationRatio)})}_updateAttributes(e){for(let n=0;n<e;n++){const r=this._blockRenderList[n];r.pos.toArray(this._instancePosArray,n*3),r.orient.toArray(this._instanceOrientArray,n*4),this._instanceShowRatioArray[n]=Er.quartInOut(r.showRatio),r.spinPivot.toArray(this._instanceSpinPivotArray,n*3),r.spinOrient.toArray(this._instanceSpinOrientArray,n*4),this._instanceNextDirectionArray.set([r.boardDir.x,r.boardDir.y],n*2)}const t=this._blocksMesh.geometry;for(const n in t.attributes){const r=t.attributes[n];r.isInstancedBufferAttribute&&(r.addUpdateRange(0,e*r.itemSize),r.needsUpdate=!0)}t.instanceCount=e}_updateStopAnimation(e,t){if(Le.result===it.STOP&&t>=Xt){const n=t-Xt,r=n%Ut-Yt,s=Math.floor(n/Ut)-Yt,o=Jt.getTile(s,r);if(!o.isOccupied){const a=Ie.saturate(mn.spawnRatio-o.randomDelay);o.activeRatio=a,e.showRatio=vi(a),e.boardPos.set(s,r)}}}_updateFailAnimation(e,t,n){if(e&&e.isErrorBlock&&e.errorLifeCycle>=z.errorBlockMaxLifeCycle-1){const r=e.currentTile,s=e.errorFallAnimationTime;t.boardPos.set(r.row,r.col),gt.set(r.row,r.col).normalize(),Math.abs(gt.x)>Math.abs(gt.y)?gt.set(Math.sign(gt.x),0):gt.set(0,Math.sign(gt.y)),t.boardDir.set(gt.x,gt.y),t.animation=Ie.fit(s*s,0,1,0,1),t.animation+=Math.max(0,s-.5),t.update(z.deltaTime),t.addsFallAnimation(Math.max(0,s-.5))}if(Le.result===it.FAILED){if(e){const r=e.currentTile;if(St.floatingCubesRatio>0){const s=Math.floor(St.floatingCubesRatio*this.animationTotalFrames),o=Math.min(s+1,this.animationTotalFrames-1),a=St.floatingCubesRatio*this.animationTotalFrames-s;gi.fromArray(r.loseAnimationPositionArray,s*3),il.fromArray(r.loseAnimationPositionArray,o*3),gi.lerp(il,a),gi.y*=.5,t.pos.set(gi.z,gi.y,-gi.x),Is.fromArray(r.loseAnimationOrientArray,s*4),rl.fromArray(r.loseAnimationOrientArray,o*4),Is.slerp(rl,a),t.orient.copy(Is)}if(St.shakeRatio>0){const s=Ie.fit(St.shakeRatio,0,1,0,1,Er.sineOut);if(gt.set(r.row,r.col),gt.normalize(),gt.multiplyScalar(.1*s),t.pos.x+=gt.x,t.pos.z-=gt.y,St.shakeRatio<1){const o=s*Ie.fit(St.shakeRatio,.5,.8,1,0);gt.set(e.randomVector.x,e.randomVector.y),gt.normalize(),gt.multiplyScalar(o),Ar.set(0,0),Ar.addScaledVector(gt,.08*o*Math.sin(o*80)),t.pos.x+=Ar.x,t.pos.z+=Ar.y}}}if(n>=Xt){const r=n-Xt,s=r%Ut-Yt,o=Math.floor(r/Ut)-Yt,a=Jt.getTile(o,s),l=Ie.saturate(St.spawnRatio-a.randomDelay);a.isOccupied||(a.activeRatio=l),t.showRatio=vi(l),t.boardPos.set(o,s)}}}_updateFloatAnimation(e,t,n){if(Le.result===it.COMPLETED&&e){const s=.1*e.currentTile.randomDelay,o=Dt.floatingCubesRatio-s;let a=Ie.fit(o,0,.5,0,1,l=>1-Math.pow(1-l,5));a=Ie.fit(o,.7,1,a,0,l=>Math.pow(l,5)),t.pos.y+=Dt.floatingCubesDisplacement*a}}update(e){this._updateFreeBlocks(e),this._updateColors(e);let t=0;for(let o=0;o<Hi;o++){let a=this._blockList[o];a.update(e);let l=Lt.blocks.filter(c=>c.id===o)[0];a.showRatio>0&&(this._blockRenderList[t++]=a),this._updateFailAnimation(l,a,o),this._updateStopAnimation(a,o),this._updateFloatAnimation(l,a,o)}this._updateInfoTexture(),this._updateAttributes(t);const n=Math.min(1,mn.pushDownRatio+St.pushDownRatio+Dt.pushDownRatio),r=Er.backOut(n,3),s=1-vi(Lt.firstStartAnimationRatio);this.container.position.y=-r-2*s,this.container.rotation.y=.5*Math.PI*s,this.container.rotation.y+=2*Math.PI*Er.quartInOut(Dt.towerRotationRatio),this._baseMesh.material.uniforms.u_yDisplacement.value=-r-5*s,this._baseMesh.material.uniforms.u_successAnimationRatio.value=Dt.successColorTowerRatio,this.sharedUniforms.u_endAnimationRatio.value=Math.min(1,Ie.fit(mn.spawnRatio,.5,2,0,1)+Ie.fit(St.spawnRatio,.5,2,0,1)+Ie.fit(Dt.ratio,0,.2,0,1)),this.sharedUniforms.u_restartAnimationRatio.value=n,this.sharedUniforms.u_goboIntensity.value=z.goboIntensity,this.sharedUniforms.u_lightPosition.value.set(z.lightPositionX,z.lightPositionY,z.lightPositionZ),this.directLight.position.copy(this.sharedUniforms.u_lightPosition.value),this.directLight.shadow.camera.near=z.lightCameraNear,this.directLight.shadow.camera.far=z.lightCameraFar,this.directLight.shadow.camera.right=z.lightCameraSize,this.directLight.shadow.camera.left=-z.lightCameraSize,this.directLight.shadow.camera.top=z.lightCameraSize,this.directLight.shadow.camera.bottom=-z.lightCameraSize,this.directLight.shadow.bias=z.lightCameraBias}}const Kn=new Rm;var al=`uniform float u_time;
...
}`,Im=`attribute vec3 a_instancePosition;
...
}`;class Fm{constructor(){I(this,"container",new ft)}init(){const e=new yt({uniforms:Object.assign({u_resolution:z.sharedUniforms.u_resolution,u_bgColor1:z.sharedUniforms.u_bgColor1,u_bgColor2:z.sharedUniforms.u_bgColor2},Pi.sharedUniforms),vertexShader:Dm,fragmentShader:Um});this.mesh=new Nt(new Ci(2,2),e),this.mesh.renderOrder=1,this.container.add(this.mesh),this.initParticles()}initParticles(){const t=new Ci(1,1),n=new Ba;n.index=t.index,Object.keys(t.attributes).forEach(a=>{n.setAttribute(a,t.attributes[a])}),n.instanceCount=50;const r=new Float32Array(50*3),s=new Float32Array(50*3);for(let a=0;a<50;a++)r[a*3]=3*(Math.random()*2-1),r[a*3+1]=1*(Math.random()*2-1),r[a*3+2]=.5+.5*Math.random(),s[a*3]=Math.random(),s[a*3+1]=Math.random(),s[a*3+2]=Math.random();n.setAttribute("a_instancePosition",new Vr(r,3)),n.setAttribute("a_instanceRandom",new Vr(s,3));const o=new yt({vertexShader:Im,fragmentShader:Nm,uniforms:{u_time:z.sharedUniforms.u_time,u_resolution:z.sharedUniforms.u_resolution,u_size:{value:.01},u_color:{value:new we},u_opacity:{value:0}},transparent:!0});this.particles=new Nt(n,o),this.particles.renderOrder=2,this.particles.frustumCulled=!1,this.container.add(this.particles)}resize(){}update(e){this.particles.material.uniforms.u_size.value=z.particlesSize,this.particles.material.uniforms.u_color.value.set(z.particlesColor),this.particles.material.uniforms.u_opacity.value=z.particlesOpacity}}const Fs=new Fm;Ze.enabled=!1;class Om{preload(e,t){ot.override(e),ot.WEBGL_OPTS.canvas=z.canvas=e.canvas,z.orbitTarget=e.orbitTarget,Kn.preload(),Cr.preload(),Pi.preInit(),z.renderer=new Zp(ot.WEBGL_OPTS),Sn.start(t)}init(){z.renderer.shadowMap.enabled=!0,z.renderer.shadowMap.type=Ta,z.scene=new Kp,z.camera=new Na(-1,1,1,-1,1,60),z.scene.add(z.camera),z.camera.position.fromArray(ot.DEFAULT_POSITION),z.orbitCamera=z.camera.clone();let e=z.orbitControls=new mm(z.orbitCamera,z.orbitTarget);e.enableDamping=!0,e.target0.fromArray(ot.DEFAULT_LOOKAT_POSITION),e.reset(),Lt.init(),Kn.init(),Cr.init(),Fs.init(),z.scene.add(Kn.container),z.scene.add(Cr.container),z.scene.add(Fs.container)}setSize(e,t){z.viewportWidth=e,z.viewportHeight=t,z.viewportResolution.set(e,window.innerHeight);let n=e*ot.DPR,r=t*ot.DPR;if(ot.USE_PIXEL_LIMIT===!0&&n*r>ot.MAX_PIXEL_COUNT){let s=n/r;r=Math.sqrt(ot.MAX_PIXEL_COUNT/s),n=Math.ceil(r*s),r=Math.ceil(r)}z.width=n,z.height=r,z.resolution.set(n,r),z.camera.aspect=n/r,z.camera.updateProjectionMatrix(),z.renderer.setSize(n,r),z.canvas.style.width=`${e}px`,z.canvas.style.height=`${t}px`}render(e){z.isPaused&&(e*=0),e=Math.min(e,1/20),z.time+=e,z.deltaTime=e,z.sharedUniforms.u_time.value=z.time,z.sharedUniforms.u_deltaTime.value=e;let t=z.sharedUniforms.u_bgColor1.value,n=z.sharedUniforms.u_bgColor2.value;t.set(z.bgColor1).convertSRGBToLinear(),n.set(z.bgColor2).convertSRGBToLinear();let r=z.viewportWidth,s=z.viewportHeight,o=z.cameraZoom*s/10,a=z.cameraOffsetX,l=z.cameraOffsetY;z.camera.zoom=o,z.camera.left=-r/2-a*r/o/2,z.camera.right=r/2-a*r/o/2,z.camera.top=s/2-l*s/o/2,z.camera.bottom=-s/2-l*s/o/2,z.camera.updateProjectionMatrix(),Pi.update(e),Lt.update(e);let c=z.camera;z.orbitControls.update(),z.orbitCamera.updateMatrix(),z.orbitCamera.matrix.decompose(c.position,c.quaternion,c.scale),c.matrix.compose(c.position,c.quaternion,c.scale),Kn.update(e),Cr.update(e),Fs.update(e),z.renderer.setClearColor(z.bgColor,1),z.renderer.render(z.scene,z.camera)}}let Di=new Om;Di.properties=z;Di.stateManager=Le;Di.STATUS=Le.STATUS;Di.RESULT=Le.RESULT;Di.setState=i=>{Le.set(i)};window[ot.APP_ID]=Di;
