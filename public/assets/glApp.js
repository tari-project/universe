...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function fo(){return new bt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wa(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function po(){return new bt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wa(),fragmentShader:`
...
`)}function Qf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Ii(i){return i!==""}function To(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ao(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const ep=/^[ \t]*#include +<([\w\d./]+)>/gm;function fa(i){return i.replace(ep,np)}const tp=new Map;function np(i,e){let t=Ne[e];if(t===void 0){const n=tp.get(e);if(n!==void 0)t=Ne[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return fa(t)}const ip=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function bo(i){return i.replace(ip,rp)}function rp(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function wo(i){let e=`precision ${i.precision} float;
...
void main() {
	...
	float fragCoordZ = 0.5 * vHighPrecisionZW[0] / vHighPrecisionZW[1] + 0.5;
    gl_FragColor = packDepthToRGBA( fragCoordZ );
}`;const Ui=2*kt,un=new Pe,vr=new Pe,xr=new U,Ko=new U,As=new Jt,jo=new Jt,$o=new De,bs=new De,Jo=new De,Sr=new De,Bn=new De;class Sm{constructor(){W(this,"container",new ft);W(this,"_baseMesh");W(this,"_blocksMesh");W(this,"_blockList",[]);W(this,"_blockRenderList",[]);W(this,"_blockUpdateRange",{start:0,count:0});W(this,"sharedUniforms",{u_lightPosition:{value:new U(-2,6,-4)},u_goboTexture:{value:null},u_goboIntensity:{value:0},u_infoTexture:{value:null},u_infoTextureLinear:{value:null},u_restartAnimationRatio:{value:0},u_endAnimationRatio:{value:0}});W(this,"successColorRatio",0);W(this,"infoTexture",null)}preload(){this._blockList=Array(Ui).fill().map(()=>new xm),this._blockRenderList=[...this._blockList],_n.loadBuf(st.ASSETS_PATH+"models/BASE.buf",e=>{this._onBaseBlocksLoaded(e)}),_n.loadBuf(st.ASSETS_PATH+"models/BOX.buf",e=>{this._onBoxLoaded(e)}),_n.loadBuf(st.ASSETS_PATH+"models/lose_animation.buf",e=>{const{position:t,orient:n}=e.attributes;this.animationTotalFrames=t.count/kt,this.loseAnimationPositionArray=t.array,this.loseAnimationOrientArray=n.array}),_n.loadTexture(st.ASSETS_PATH+"textures/gobo.jpg",e=>{e.flipY=!1,e.needsUpdate=!0,this.sharedUniforms.u_goboTexture.value=e})}_onBaseBlocksLoaded(e){const t=new bt({uniforms:{...Ir.merge([ae.lights]),...K.sharedUniforms,...this.sharedUniforms,...yi.sharedUniforms,u_color:{value:new De(this.neutralColor)},u_blocksColor:{value:new De},u_yDisplacement:{value:0},u_prevSuccessColor:{value:new De(K.successColor).convertSRGBToLinear()},u_successColor:{value:new De(K.successColor).convertSRGBToLinear()},u_successAnimationRatio:{value:0}},vertexShader:gr,fragmentShader:qo,lights:!0});this._baseMesh=new Bt(e,t),this._baseMesh.receiveShadow=this._baseMesh.castShadow=!1,this._baseMesh.frustumCulled=!1,this._baseMesh.material.defines.IS_BASE=!0,this._baseMesh.customDepthMaterial=new bt({vertexShader:gr,fragmentShader:Zo,defines:{IS_DEPTH:!0,IS_BASE:!0}}),this.container.add(this._baseMesh)}_onBoxLoaded(e){const t=new Ll;t.index=e.index,Object.keys(e.attributes).forEach(s=>{t.setAttribute(s,e.attributes[s])}),t.instanceCount=Ui;const n=(s,o)=>{const a=new Float32Array(Ui*o);return t.setAttribute(s,new Cl(a,o).setUsage(Rc)),a};this._instancePosArray=n("instancePos",3),this._instanceOrientArray=n("instanceOrient",4),this._instanceShowRatioArray=n("instanceShowRatio",1),this._instanceSpinPivotArray=n("instanceSpinPivot",3),this._instanceSpinOrientArray=n("instanceSpinOrient",4),this._instanceColorArray=n("instanceColor",3),this._instanceIsActiveArray=n("instanceIsActive",1),this._instanceNextDirectionArray=n("instanceNextDirection",2);const r=new bt({uniforms:{...Ir.merge([ae.lights]),...K.sharedUniforms,...this.sharedUniforms,...yi.sharedUniforms},vertexShader:gr,fragmentShader:qo,lights:!0});this._blocksMesh=new Bt(t,r),this._blocksMesh.frustumCulled=!1,this._blocksMesh.castShadow=this._blocksMesh.receiveShadow=!0,this._blocksMesh.customDepthMaterial=new bt({uniforms:{...this.sharedUniforms},vertexShader:gr,fragmentShader:Zo,defines:{IS_DEPTH:!0}}),this.container.add(this._blocksMesh)}_onLoseAnimationLoaded(e){const{position:t,orient:n}=e.attributes;this.animationTotalFrames=t.count/kt,this.loseAnimationPositionArray=t.array,this.loseAnimationOrientArray=n.array}init(){this.directLight=new em(16777215,1),this.directLight.castShadow=!0,this.directLight.shadow.camera.near=K.lightCameraNear,this.directLight.shadow.camera.far=K.lightCameraFar,this.directLight.shadow.camera.right=K.lightCameraSize,this.directLight.shadow.camera.left=-K.lightCameraSize,this.directLight.shadow.camera.top=K.lightCameraSize,this.directLight.shadow.camera.bottom=-K.lightCameraSize,this.directLight.shadow.bias=K.lightCameraBias,this.directLight.shadow.mapSize.width=768,this.directLight.shadow.mapSize.height=768,K.scene.add(this.directLight),K.scene.add(this.directLight.target),this.isShadowCameraHelperVisible=!1,this.shadowCameraHelper=new tm(this.directLight.shadow.camera,1,"#ff0000"),K.lightCameraUpdateSignal.add(()=>{this.directLight.shadow.camera.updateProjectionMatrix(),this.shadowCameraHelper.update()}),K.lightCameraHelperSignal.add(()=>{this.isShadowCameraHelperVisible=!this.isShadowCameraHelperVisible,this.isShadowCameraHelperVisible?K.scene.add(this.shadowCameraHelper):K.scene.remove(this.shadowCameraHelper)}),this._assignFinalAnimationToTiles();let e=new Float32Array(mm*4);for(let t=0,n=0;t<dn;t++)for(let r=0;r<dn;r++,n+=4)e[n+0]=0,e[n+1]=0,e[n+2]=1,e[n+3]=1;this.infoTexture=new Do(e,dn,dn,Ot,jt),this.infoTextureLinear=new Do(e,dn,dn,Ot,jt,_a,pn,pn,Lt,Lt,0),this.infoTextureLinear.needsUpdate=!0,this.sharedUniforms.u_infoTexture.value=this.infoTexture,this.sharedUniforms.u_infoTextureLinear.value=this.infoTextureLinear}_assignFinalAnimationToTiles(){nn.tiles.forEach((e,t)=>{e.forEach((n,r)=>{const s=t*Pt+r;n.loseAnimationPositionArray=new Float32Array(this.animationTotalFrames*3),n.loseAnimationOrientArray=new Float32Array(this.animationTotalFrames*4);for(let o=0;o<this.animationTotalFrames;o++){const a=(o*kt+s)*3,l=(o*kt+s)*4;n.loseAnimationPositionArray.set(this.loseAnimationPositionArray.subarray(a,a+3),o*3),n.loseAnimationOrientArray.set(this.loseAnimationOrientArray.subarray(l,l+4),o*4)}})})}reset(){this.successColorRatio=0,this._blockList.forEach(e=>e.reset())}_updateColors(e){$o.set(K.mainColor),bs.set(K.successColor),Jo.set(K.failColor),Sr.set(K.neutralColor),Bn.copy($o),Ie.isFailResult&&Ye.endSpawnAnimationRatio===1&&Bn.copy(Jo),Ie.result===ut.COMPLETED&&(this.successColorRatio=Math.min(1,this.successColorRatio+.5*e),Bn.lerp(bs,this.successColorRatio)),Ie.result!==ut.COMPLETED&&Bn.lerp(Sr,gt.saturate(Ye.restartAnimationRatio)),Sr.convertSRGBToLinear();for(let n=0;n<Ui;n++){const r=n<Ye.blocks.length+(Ye.lastSpawnedBlock?1:0),s=r?Bn:Sr;this._instanceColorArray.set([s.r,s.g,s.b],n*3),this._instanceIsActiveArray[n]=r?1:0}const t=this._baseMesh.material.uniforms;t.u_color.value.set(K.neutralColor),t.u_blocksColor.value.copy(Bn),t.u_prevSuccessColor.value.set(K.neutralColor),t.u_prevSuccessColor.value.lerp(Bn.set(bs),Ye.previousSuccessBlocksAnimationRatio),t.u_prevSuccessColor.value.convertSRGBToLinear()}_updateInfoTexture(){nn.tiles.forEach(e=>{e.forEach(t=>{let n=t.id%Pt+1,s=((Math.floor(t.id/Pt)+1)*dn+n)*4;this.infoTexture.image.data[s+0]=t.activeRatio*(Ye.endAnimationRatio%1<.01?1:0),this.infoTexture.image.data[s+1]=t.isOccupied||t.willBeOccupied?1:0,this.infoTexture.image.data[s+2]=t.isMain?1:0,this.infoTexture.image.data[s+3]=t.isBorder?1:0})}),this.infoTexture.needsUpdate=!0,this.infoTextureLinear.needsUpdate=!0}_updateFreeBlocks(e){if(Ye.lastSpawnedBlock){const t=this._blockList[Ye.lastSpawnedBlock.id];t.boardPos.set(Ye.lastSpawnedBlock.currentTile.row,Ye.lastSpawnedBlock.currentTile.col),t.showRatio=Gn(gt.saturate(Ye.lastSpawnedBlock.spawnAnimationRatioUnclamped))}Ye.blocks.forEach(t=>{const n=this._blockList[t.id];n&&(n.showRatio=Gn(gt.saturate(t.spawnAnimationRatioUnclamped)),n.boardPos.set(t.currentTile.row,t.currentTile.col),t.targetTile&&n.boardDir.set(t.targetTile.row-t.currentTile.row,t.targetTile.col-t.currentTile.col),n.animation=t.hasAnimationEnded?0:t.easedAnimationRatio)})}_updateAttributes(e){for(let n=0;n<e;n++){const r=this._blockRenderList[n];r.pos.toArray(this._instancePosArray,n*3),r.orient.toArray(this._instanceOrientArray,n*4),this._instanceShowRatioArray[n]=Vo.quartInOut(r.showRatio),r.spinPivot.toArray(this._instanceSpinPivotArray,n*3),r.spinOrient.toArray(this._instanceSpinOrientArray,n*4),this._instanceNextDirectionArray.set([r.boardDir.x,r.boardDir.y],n*2)}const t=this._blocksMesh.geometry;for(const n in t.attributes){const r=t.attributes[n];r.isInstancedBufferAttribute&&(r.addUpdateRange(0,e*r.itemSize),r.needsUpdate=!0)}t.instanceCount=e}_updateStopAnimation(e,t){if(Ie.result===ut.STOP&&t>=kt){const n=t-kt,r=n%Pt-Vt,s=Math.floor(n/Pt)-Vt,o=nn.getTile(s,r);if(!o.isOccupied){const a=gt.saturate(Ye.endSpawnAnimationRatioUnclamped-o.randomDelay);o.activeRatio=a,e.showRatio=Gn(a),e.boardPos.set(s,r)}}}_updateFailAnimation(e,t,n){if(Ie.result===ut.FAILED){if(e){const r=e.currentTile;if(Ye.endAnimationRatio>0){const s=Math.floor(Ye.endAnimationRatio*this.animationTotalFrames),o=Math.min(s+1,this.animationTotalFrames-1),a=Ye.endAnimationRatio*this.animationTotalFrames-s;xr.fromArray(r.loseAnimationPositionArray,s*3),Ko.fromArray(r.loseAnimationPositionArray,o*3),xr.lerp(Ko,a),xr.y*=.5,t.pos.copy(xr),As.fromArray(r.loseAnimationOrientArray,s*4),jo.fromArray(r.loseAnimationOrientArray,o*4),As.slerp(jo,a),t.orient.copy(As)}if(Ye.failShakeAnimationRatio>0){const s=gt.fit(Ye.failShakeAnimationRatio,0,1,0,1,Vo.sineOut);if(un.set(r.row,r.col),un.normalize(),un.multiplyScalar(.1*s),t.pos.x+=un.x,t.pos.z-=un.y,Ye.failShakeAnimationRatio<1){const o=s*gt.fit(Ye.failShakeAnimationRatio,.5,.8,1,0);un.set(e.randomVector.x,e.randomVector.y),un.normalize(),un.multiplyScalar(o),vr.set(0,0),vr.addScaledVector(un,.08*o*Math.sin(o*40)),t.pos.x+=vr.x,t.pos.z+=vr.y}}}if(n>=kt){const r=n-kt,s=r%Pt-Vt,o=Math.floor(r/Pt)-Vt,a=nn.getTile(o,s),l=gt.saturate(Ye.endSpawnAnimationRatioUnclamped-a.randomDelay);a.isOccupied||(a.activeRatio=l),t.showRatio=Gn(l),t.boardPos.set(o,s)}}}_updateFloatAnimation(e,t,n){if(Ie.result===ut.COMPLETED&&e){const s=.2*e.currentTile.randomDelay,o=Ye.endFloatingAnimationRatioUnclamped-s;let a=gt.fit(o,0,.5,0,1,l=>1-Math.pow(1-l,5));a=gt.fit(o,.8,1,a,0,l=>Math.pow(l,5)),t.pos.y+=a}}update(e){this._updateFreeBlocks(e),this._updateColors(e);let t=0;for(let s=0;s<Ui;s++){let o=this._blockList[s];o.update(e);let a=Ye.blocks.filter(l=>l.id===s)[0];o.showRatio>0&&(this._blockRenderList[t++]=o),this._updateFailAnimation(a,o,s),this._updateStopAnimation(o,s),this._updateFloatAnimation(a,o,s)}this._updateInfoTexture(),this._updateAttributes(t);const n=Gn(Ye.restartAnimationRatio),r=1-Gn(Ye.firstStartAnimationRatio);this.container.position.y=-n-2*r,this.container.rotation.y=.5*Math.PI*r,this._baseMesh.material.uniforms.u_yDisplacement.value=-n-5*r,this._baseMesh.material.uniforms.u_successAnimationRatio.value=gt.fit(Ye.endCoinsAnimationRatio,.025,1,0,1),this.sharedUniforms.u_endAnimationRatio.value=Ie.result===ut.COMPLETED?Ye.restartAnimationRatio:Ye.endAnimationRatio,this.sharedUniforms.u_restartAnimationRatio.value=Ye.restartAnimationRatio,this.sharedUniforms.u_goboIntensity.value=K.goboIntensity,this.sharedUniforms.u_lightPosition.value.set(K.lightPositionX,K.lightPositionY,K.lightPositionZ),this.directLight.position.copy(this.sharedUniforms.u_lightPosition.value),this.directLight.shadow.camera.near=K.lightCameraNear,this.directLight.shadow.camera.far=K.lightCameraFar,this.directLight.shadow.camera.right=K.lightCameraSize,this.directLight.shadow.camera.left=-K.lightCameraSize,this.directLight.shadow.camera.top=K.lightCameraSize,this.directLight.shadow.camera.bottom=-K.lightCameraSize,this.directLight.shadow.bias=K.lightCameraBias}}const fi=new Sm;var Qo=`uniform float u_time;
...
}`;class bm{constructor(){W(this,"container",new ft)}init(){const e=new bt({uniforms:Object.assign({u_resolution:K.sharedUniforms.u_resolution,u_bgColor1:K.sharedUniforms.u_bgColor1,u_bgColor2:K.sharedUniforms.u_bgColor2},yi.sharedUniforms),vertexShader:Tm,fragmentShader:Am});this.mesh=new Bt(new ki(2,2),e),this.mesh.renderOrder=1,this.container.add(this.mesh)}resize(){}update(e){}}const ws=new bm;class wm{preload(e,t){st.override(e),st.WEBGL_OPTS.canvas=K.canvas=e.canvas,K.orbitTarget=e.orbitTarget,fi.preload(),Mr.preload(),yi.preInit(),K.renderer=new Vp(st.WEBGL_OPTS),_n.start(t)}init(){K.renderer.shadowMap.enabled=!0,K.renderer.shadowMap.type=ma,K.scene=new Wp,K.camera=new ba(-1,1,1,-1,1,60),K.scene.add(K.camera),K.camera.position.fromArray(st.DEFAULT_POSITION),K.orbitCamera=K.camera.clone();let e=K.orbitControls=new om(K.orbitCamera,K.orbitTarget);e.enableDamping=!0,e.target0.fromArray(st.DEFAULT_LOOKAT_POSITION),e.reset(),Ye.init(),fi.init(),Mr.init(),ws.init(),K.scene.add(fi.container),K.scene.add(Mr.container),K.scene.add(ws.container)}setSize(e,t){K.viewportWidth=e,K.viewportHeight=t,K.viewportResolution.set(e,window.innerHeight);let n=e*st.DPR,r=t*st.DPR;if(st.USE_PIXEL_LIMIT===!0&&n*r>st.MAX_PIXEL_COUNT){let s=n/r;r=Math.sqrt(st.MAX_PIXEL_COUNT/s),n=Math.ceil(r*s),r=Math.ceil(r)}K.width=n,K.height=r,K.resolution.set(n,r),K.camera.aspect=n/r,K.camera.updateProjectionMatrix(),K.renderer.setSize(n,r),K.canvas.style.width=`${e}px`,K.canvas.style.height=`${t}px`}render(e){K.isPaused&&(e*=0),K.time+=e,K.deltaTime=e,K.sharedUniforms.u_time.value=K.time,K.sharedUniforms.u_deltaTime.value=e;let t=K.sharedUniforms.u_bgColor1.value,n=K.sharedUniforms.u_bgColor2.value;t.set(K.bgColor1),n.set(K.bgColor2);let r=K.viewportWidth,s=K.viewportHeight,o=K.cameraZoom*s/10,a=K.cameraOffsetX,l=K.cameraOffsetY;K.camera.zoom=o,K.camera.left=-r/2-a*r/o/2,K.camera.right=r/2-a*r/o/2,K.camera.top=s/2-l*s/o/2,K.camera.bottom=-s/2-l*s/o/2,K.camera.updateProjectionMatrix(),yi.update(e),Ye.update(e);let c=K.camera;K.orbitControls.update(),K.orbitCamera.updateMatrix(),K.orbitCamera.matrix.decompose(c.position,c.quaternion,c.scale),c.matrix.compose(c.position,c.quaternion,c.scale),fi.update(e),Mr.update(e),ws.update(e),K.renderer.setClearColor(K.bgColor,1),K.renderer.render(K.scene,K.camera)}}let Ai=new wm;Ai.properties=K;Ai.stateManager=Ie;Ai.STATUS=Ie.STATUS;Ai.RESULT=Ie.RESULT;Ai.setState=i=>{Ie.set(i)};window[st.APP_ID]=Ai;
