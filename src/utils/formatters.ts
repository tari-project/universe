...
export function formatHashrate(hashrate: number, joinUnit = true, algo?: GpuMiningAlgorithm): Hashrate {
    // C29 (cuckoo cycle) uses graphs per second, RandomX/CPU uses hashes per second
