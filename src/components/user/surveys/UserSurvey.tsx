...
export default function UserSurvey({ type, onSuccess, onSkipped }: UserSurveyProps) {
    ...
    const markup = !!survey && (
        <>
            ...
            {survey.questions && <SurveyForm surveyContent={survey} onSkipped={onSkipped} onSuccess={onSuccess} />}
        </>
    );
