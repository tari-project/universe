...
export const InternalWalletOption = forwardRef<HTMLDivElement, XCOptionProps>(
    ({ isCurrent = false, isActive, onActiveClick }, ref) => {
        ...
        const isTari =
            universalExchangeMinerOption.slug === 'universal' && universalExchangeMinerOption.id === 'universal';
...
InternalWalletOption.displayName = 'InternalWalletOption';
