...
export const XCOption = forwardRef<HTMLDivElement, XCOptionProps>(
    ({ content, isCurrent = false, isActive, onActiveClick }, ref) => {
                    ...
                    {isActive ? (
                        <ContentBodyWrapper>
                            <ExchangeAddress
                                ...
                                value={
                                    isCurrent && base_tari_address ? truncateMiddle(base_tari_address, 7, ' ... ') : ''
                                }
                            />
