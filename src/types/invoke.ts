...
declare module '@tauri-apps/api/core' {
    ...
    function invoke(param: 'send_data_telemetry_service', payload: { threads: number }): Promise<void>;
    function invoke(param: 'set_user_inactivity_timeout', payload: { event_name: string; data: object }): Promise<void>;
